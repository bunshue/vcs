...
namespace vcs_test_all_24_DllImport_GetMediaLength
{
    public partial class Form1 : Form
    {
        ...
        {
            label1.Text = (GetMediaLen(@"C:\______test_vcs\WindowsShutdown.wav").ToString() + " 秒");
            //label1.Text = (GetMediaLen(@"C:\aaaa.mp3").ToString() + " 秒");
            //label1.Text = (GetMediaLen(@"F:\_______VIDEO_ALL_all1\[诸神字幕组][TBS][世界遗产][20160124 加德满都谷地].mp4").ToString() + " 秒");
        }
