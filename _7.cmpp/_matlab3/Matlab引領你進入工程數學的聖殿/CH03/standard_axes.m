...
%STANDARD_AXES   建立標准座標系
% STANDARD_AXES  將目前座標系轉化為標准座標系
% STANDARD_AXES(H)  將由H特殊的座標系轉化為標准座標系
% AX=STANDARD_AXES(...)  傳回轉化後的標准座標系的橫軸和縱軸的控制碼向量
% [AX1,AX2]=STANDARD_AXES(...)  傳回轉化後的標准座標系的橫軸控制碼和縱軸控制碼
%
% 輸導入參數數：
%     ---H：特殊的座標軸控制碼
% 輸出參數：
%     ---AX,AX1,AX2：標准座標系的橫軸和縱軸控制碼
%
