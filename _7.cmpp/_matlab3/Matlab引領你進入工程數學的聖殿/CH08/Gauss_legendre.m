...
%GAUSS_LEGENDRE   高斯-勒讓德方法計算數值積分
% I=GAUSS_LEGENDRE(FUN,A,B,M)  高斯-勒讓德方法計算函數FUN在積分區間[A,B]上的
%                              數值積分，並指定每段高斯點數為M
% I=GAUSS_LEGENDRE(FUN,A,B,M,N)  高斯-勒讓德方法計算函數FUN在積分區間[A,B]上的
%                                數值積分，並指定每段高斯點數為M和區間等分數N
% I=GAUSS_LEGENDRE(FUN,A,B,M,N,P1,P2,...)  高斯-勒讓德方法計算函數FUN的
%                                          數值積分，其中函數FUN帶有附加參數
%
% 輸導入參數數：
%     ---FUN：被積函數
