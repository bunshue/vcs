...
class Window:
    def __init__(self):
        ...
        self.buttonBrowserLogo = tkinter.Button(
            root, text="瀏覽", command=self.BrowserLogo
        )
        self.buttonBrowserLogo.place(x=200, y=5)
        self.checkM = tkinter.Checkbutton(
            root,
            text="批次轉換",
        ...
        self.buttonBrowserFile = tkinter.Button(
            root, text="瀏覽", command=self.BrowserFile
        )
        ...
        self.buttonBrowserDir = tkinter.Button(
            root, text="瀏覽", command=self.BrowserDir, state=tkinter.DISABLED
        )
        self.buttonBrowserDir.place(x=200, y=80)

        self.checkF = tkinter.Checkbutton(
            root,
            text="改變檔案格式",
        ...
        self.rBmp = tkinter.Radiobutton(
            frame, variable=self.Image, value="bmp", text="BMP", state=tkinter.DISABLED
        )
        self.rBmp.pack(anchor="w")
        self.rJpg = tkinter.Radiobutton(
            frame, variable=self.Image, value="jpg", text="JPG", state=tkinter.DISABLED
        )
        self.rJpg.pack(anchor="w")
        self.rGif = tkinter.Radiobutton(
            frame, variable=self.Image, value="gif", text="GIF", state=tkinter.DISABLED
        )
        self.rGif.pack(anchor="w")
        self.rPng = tkinter.Radiobutton(
            frame, variable=self.Image, value="png", text="PNG", state=tkinter.DISABLED
        )
        ...
        self.rRB = tkinter.Radiobutton(
            pframe, variable=self.pstatus, value=3, text="右下角"
        )
        self.rRB.pack(anchor="w")
        self.buttonAdd = tkinter.Button(root, text="加入", command=self.Add)
