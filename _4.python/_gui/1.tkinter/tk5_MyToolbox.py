...
button00 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button00"),
)  # 給參數
...
button01 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button01"),
)  # 給參數
...
button02 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button02"),
)  # 給參數
...
button03 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button03"),
)  # 給參數
...
button10 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button10"),
)  # 給參數
...
button11 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button11"),
)  # 給參數
...
button12 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button12"),
)  # 給參數
...
button13 = tk.Button(
    ...
    bg="white",
    fg="black",
    command=lambda: buttonClick("button13"),
)  # 給參數
