...
progressbar7 = ttk.Progressbar(
    window, orient=tk.HORIZONTAL, variable=scale7_value_int, length=150
)
progressbar7.pack()
progressbar7.start()
...
frame3 = tk.Frame(
    labelframe1, width=100, height=180, relief="raised", borderwidth=3, bg="white"
)
