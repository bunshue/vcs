...
filename = 'C:/_git/vcs/_1.data/______test_files1/_opencv/captcha/captcha03.png'
...
plt.subplot(223)
plt.title('轉為反相黑白')
plt.imshow(cv2.cvtColor(inv, cv2.COLOR_BGR2RGB))
...
dilation = cv2.dilate(inv, (8, 8), iterations=1)  #圖形加粗 擴大使膨脹
plt.subplot(224)
plt.title('擴大使膨脹')
