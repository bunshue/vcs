...
hist_mask = cv2.calcHist(
    [image_mask[offset : 480 - offset, offset : 640 - offset]], [0], None, [256], [0, 256]
)
...
plt.figure(num = 'histogram', figsize = (12, 8), dpi = 100, facecolor = "whitesmoke", edgecolor = "r", linewidth = 1, frameon = True)
