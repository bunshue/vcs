...
image = np.random.randint(0, 256, size = [2, 3, 3], dtype = np.uint8)  #np.random之randint不含尾
...
image = np.random.randint(-256, 256, size = [4, 5], dtype = np.int16)  #np.random之randint不含尾
