...
faces1 = [36,36,122,122]
faces2 = [216,41,132,132]
faces3 = [382,53,119,119]
faces4 = [594,47,119,119]
...
df = DeepFace.find(img_path = filename1, db_path = 'data/deepface/member', enforce_detection=False)
