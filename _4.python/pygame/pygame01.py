...
pygame.draw.circle(ball, RED, (30, 30), 30, 0)  # 實心圓, 線寬0
...
x_st, y_st = rect1.topleft  # 球左上角坐標
...
screen.blit(surface, (500, 600))  # blit, 將畫布surface blit到視窗screen裏, 位置
