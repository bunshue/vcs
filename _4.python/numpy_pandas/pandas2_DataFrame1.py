...
mars = pd.read_json("data3/mars_data_01.json")
print(mars)

temp = pd.read_csv(
    "data3/temp_data_01.csv", header=0, names=range(18), usecols=range(4, 18)
)
print(temp)

temp = pd.read_csv("data3/temp_data_01.csv", na_values=["Missing"])
print(temp)

temp = pd.read_csv(
    "data3/temp_data_01.csv",
    na_values=["Missing"],
    header=0,
    names=range(18),
    usecols=range(4, 18),
...
calls = pd.read_csv("data3/sales_calls.csv")
print(calls)

revenue = pd.read_csv("data3/sales_revenue.csv")
print(revenue)
