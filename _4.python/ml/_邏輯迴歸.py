...
print("------------------------------------------------------------")  # 60個
# 用邏輯迴歸做 hypothyroid 甲狀腺功能低下症 ST
print("------------------------------------------------------------")  # 60個

# Logistic regression example

# hypothyroid 甲狀腺功能低下症
...
print("------------------------------------------------------------")  # 60個
# 用邏輯迴歸做 hypothyroid 甲狀腺功能低下症 SP
print("------------------------------------------------------------")  # 60個
