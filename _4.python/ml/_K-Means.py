...
# 標記群集中心
plt.scatter(clf.cluster_centers_[:, 0], clf.cluster_centers_[:, 1], marker="*", s=200, c="r", alpha=0.8)
...
# 看視覺化圖表決定參數K值
plt.plot(list(range(1, 15)), inertia, color="r", marker="o", markersize=8, label="分群準確性")
plt.grid()
plt.legend()
