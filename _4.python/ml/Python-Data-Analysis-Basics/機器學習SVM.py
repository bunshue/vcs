...
plt.figure(num = 'SVM 支援向量機', figsize = (20, 11), dpi = 84, facecolor = "whitesmoke", edgecolor = "r", linewidth = 1, frameon = True)
...
#再來視覺化一下我們的成果
gd = np.array([[i, j] for i in np.arange(-7, 7, 0.2)
               for j in np.arange(-7, 7, 0.2) ])
