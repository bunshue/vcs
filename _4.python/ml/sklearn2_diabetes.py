...
cc = pd.DataFrame({'variable': diabetes_sklearn.feature_names, 'estimate': ols_reg.coef_})
...
ridge_df = pd.DataFrame({'variable': diabetes_sklearn.feature_names, 'estimate': ridge_reg.coef_})
ridge_train_pred = []
ridge_test_pred = []
...
lasso_df = pd.DataFrame({'variable': diabetes_sklearn.feature_names, 'estimate': lasso_reg.coef_})
lasso_train_pred = []
lasso_test_pred = []
