...
# 使用 name, ok
txt = driver.find_element(By.NAME, 'search_query')             # 取得屬性 name 為 xxxx 的網頁元素 ( TextArea )
...
# txt = driver.find_element(By.CLASS_NAME, 'ytd-searchbox') # 取得 class 為 xxxx 的網頁元素 ( TextArea )
# 使用 id, ok
txt = driver.find_element(By.ID, 'header-search-input')        # 取得 id 為 xxxx 的網頁元素 ( TextArea )
# 使用 name, ok
...
# 使用 class, ok
txt = driver.find_element(By.CLASS_NAME, 'vector-search-box-input') # 取得 class 為 xxxx 的網頁元素 ( TextArea )
# 使用 id, ok
