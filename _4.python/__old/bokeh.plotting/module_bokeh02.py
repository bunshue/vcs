...
detailed_name = (
    "detailed_name" if counties[0].get("detailed_name") else "detailed name"
)  # detailed name was changed in Bokeh 3.0
choropleth = hv.Polygons(
    counties, ["lons", "lats"], [(detailed_name, "County"), "Unemployment"]
)
