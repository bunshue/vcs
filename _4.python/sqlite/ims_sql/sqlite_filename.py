...
tablename = ''
db_filename = ''
#db_filename = 'C:/_git/vcs/_1.data/______test_files2/filename_' + time.strftime("%Y%m%d_%H%M%S", time.localtime()) + '.sqlite';
...
icon_filename = 'C:/_git/vcs/_1.data/______test_files1/_icon/chicken.ico'
