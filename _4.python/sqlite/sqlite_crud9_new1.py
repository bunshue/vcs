...
CREATE TABLE IF NOT EXISTS table01 (
  ...
  update_time DATE CHECK(update_time > birthday),
...
sql = "INSERT INTO table01 (name, birthday, update_time, money) VALUES ('Joe', '1980-02-02', '1990-04-04', 1234);"
