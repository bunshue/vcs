...
def generate_invoice():
    ...
    print('取得購買清單: ', invoice_list)

    print('取得 name :', name)
    print('取得 phone :', phone)
    print('取得 subtotal :', subtotal)
    print('取得 salestax :', str(salestax * 100) + "%")
    print('取得 total :', total)
...
save_invoice_button = tkinter.Button(frame, text = "建立發票", command = generate_invoice)
