...
btnDoInput.pack()
labelmsgInput = tk.Label(
    frameInputCheck, textvariable=msginput, fg="red", font=("新細明體", 10)
)
labelmsgInput.pack()
...
labelewordSearch = tk.Label(
    frameSearch, text="請輸入要查詢的英文單字", fg="blue", font=("新細明體", 10)
)
...
btnDoSearch.pack()
labelmsgSearch = tk.Label(
    frameSearchChech, textvariable=msgSearch, fg="red", font=("新細明體", 10)
)
labelmsgSearch.pack()
...
labelewordedit = tk.Label(
    frameEdit, text="請輸入要修改的英文單字(Enter 結束輸入)", fg="blue", font=("新細明體", 10)
)
...
btnDoedit.pack()
labelmsgedit = tk.Label(
    frameEditCheck, textvariable=msgedit, fg="red", font=("新細明體", 10)
)
labelmsgedit.pack()
...
labelewordDelete = tk.Label(
    frameDelete, text="請輸入要刪除的英文單字(Enter 結束輸入)", fg="blue", font=("新細明體", 10)
)
...
btnDoDelete.pack()
labelmsgDelete = tk.Label(
    frameDeleteCheck, textvariable=msgDelete, fg="red", font=("新細明體", 10)
)
labelmsgDelete.pack()
