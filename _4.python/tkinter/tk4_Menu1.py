...
# 第3排功能選單 Help
menu3 = tk.Menu(menu0, tearoff=0)
menu0.add_cascade(label="說明(H)", menu=menu3, underline=0)
menu3.add_command(label="關於(A)", command=lambda: print("你按了 關於"), underline=1)
...
menu1.add_command(
    label="開啟新檔", underline=1, accelerator="Ctrl+N", command=lambda: print("你按了 開啟新檔")
)
menu1.add_command(
    label="開啟", underline=1, accelerator="Ctrl+O", command=lambda: print("你按了 開啟舊檔")
)
menu1.add_separator()  # 增加分隔線
menu1.add_command(
    label="儲存", underline=1, accelerator="Ctrl+S", command=lambda: print("你按了 另存新檔")
)
menu1.add_separator()  # 增加分隔線
menu1.add_command(
    label="離開", underline=1, accelerator="Ctrl+Q", command=lambda: window.destroy()
)
