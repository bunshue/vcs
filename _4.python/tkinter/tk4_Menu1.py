...
menu1 = tk.Menu(menu0, tearoff=0)
menu0.add_cascade(label="檔案(F)",menu=menu1)
menu1.add_command(label="開新檔案",command = lambda: print('你按了 開新檔案'))
menu1.add_command(label="開啟舊檔",command = lambda: print('你按了 開啟舊檔'))
menu1.add_separator()  # 增加分隔線
menu1.add_command(label="儲存檔案",command = lambda: print('你按了 儲存檔案'))
menu1.add_command(label="另存新檔",command = lambda: print('你按了 另存新檔'))
...
#第2排功能選單 Help
menu2 = tk.Menu(menu0, tearoff=0)
menu0.add_cascade(label="說明(H)",menu=menu2)
menu2.add_command(label="關於(A)",command = lambda: print('你按了 關於'))
...
#第1排功能選單 File
menu1 = tk.Menu(menu0, tearoff=0)
menu0.add_cascade(label="檔案(F)",menu=menu1,underline=0)
menu1.add_command(label="開新檔案",command = lambda: print('你按了 開新檔案'),underline=0)
menu1.add_command(label="開啟舊檔",command = lambda: print('你按了 開啟舊檔'),underline=0)
menu1.add_separator()  # 增加分隔線
menu1.add_command(label="儲存檔案",command = lambda: print('你按了 儲存檔案'),underline=0)
menu1.add_command(label="另存新檔",command = lambda: print('你按了 另存新檔'),underline=5)
menu1.add_separator()  # 增加分隔線
menu1.add_command(label="離開",command=window.destroy,underline=0)

#第2排功能選單 Help
menu2 = tk.Menu(menu0, tearoff=0)
menu0.add_cascade(label="說明(H)",menu=menu2,underline=0)
menu2.add_command(label="關於(A)",command = lambda: print('你按了 關於'),underline=1)
...
menu1 = tk.Menu(menu0, tearoff=0)
menu0.add_cascade(label="檔案(F)",menu=menu1)
menu1.add_command(label="開新檔案", command = lambda: print('開新檔案'))
menu1.add_separator()  # 增加分隔線
menu1.add_command(label="儲存檔案", command = lambda: print('儲存檔案'))
menu1.add_separator()  # 增加分隔線
menu1.add_command(label="離開",command=window.destroy)
...
menu2 = tk.Menu(menu0, tearoff=0)
menu0.add_cascade(label="說明(H)",menu=menu2)
menu2.add_command(label="關於(A)", command = lambda: print('關於'))
...
menu3b.add_command(label = 'some more stuff', command = lambda: print('你按了 some more stuff'))
...
class Application(tk.Frame):
    ...
    def create_menu(self):
        ...
        menu1.add_command(label="儲存檔案", command = lambda: print('你按了 儲存檔案'))
        menu1.add_separator()  # 增加分隔線
        menu1.add_command(label="結束", command=self.master.quit)
        ...
        menu3.add_command(label="執行程式", command=self.run)

        # 建立 說明(H) 主功能  About
        #第4排功能選單 Help
        menu4 = tk.Menu(menu0, tearoff=0)
        menu0.add_cascade(label="說明(H)", menu=menu4)
        menu4.add_command(label="關於(A)", command = lambda: print('你按了 關於'))
