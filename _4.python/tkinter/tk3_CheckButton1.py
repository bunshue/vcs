...
for i in range(0, len(ball)):
    item = tk.IntVar()
    choice.append(item)
    item = tk.Checkbutton(window, text = ball[i], variable = choice[i], command = checkbutton_select1)
    item.pack()
...
for i in range(len(sports)):                # 將運動字典轉成核取方塊
    ...
    tk.Checkbutton(window,text=sports[i],
...
tk.Label(window, 
      text = "請問您的最高學歷: ", justify = tk.LEFT, padx = 20).pack()
...
for item, val in place:
    tk.Radiobutton(window, text = item, value = val,
        ...
        command = checkbutton_select8).pack()
...
for item, val in place:
    tk.Radiobutton(window, text = item, value = val,
                   variable = var, padx = 20,
                   command = checkbutton_select9).pack()
...
checkbutton1 = tk.Checkbutton(window,text="Checkbutton 1",variable=var_checkbutton1, command=command_checkbutton1)
checkbutton1.pack()

var_checkbutton2 = tk.BooleanVar()
checkbutton2 = tk.Checkbutton(window,text="Checkbutton 2",variable=var_checkbutton2, command=command_checkbutton2)
checkbutton2.pack()
