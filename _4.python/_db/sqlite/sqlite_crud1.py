...
db_filename = (
    "tmp_db15_" + time.strftime("%Y%m%d_%H%M%S", time.localtime()) + "_csv.sqlite"
)
...
cursor.execute("INSERT INTO salary VALUES (?, ?, ?, ?, ?)", VALUES)
conn.commit()
...
sqlstr = "INSERT INTO table01 VALUES (?, ?)"
sqlstr = "INSERT INTO table01 (name, date) VALUES (?, ?)"
