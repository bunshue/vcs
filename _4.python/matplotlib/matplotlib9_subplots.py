...
print("用plt畫圖")
plt.plot(x, y0, "r-o", label="sin")
plt.plot(x, y1, "g-o", label="cos")
...
ax.plot(x, y0, "r-o", label="sin")
ax.plot(x, y1, "g-o", label="cos")
...
ax[0][0].set_xlabel("x_label0")
ax[0][1].set_xlabel("x_label1")
ax[1][0].set_xlabel("x_label2")
ax[1][1].set_xlabel("x_label3")
ax[0][0].set_ylabel("y_label0")
ax[0][1].set_ylabel("y_label1")
ax[1][0].set_ylabel("y_label2")
ax[1][1].set_ylabel("y_label3")
