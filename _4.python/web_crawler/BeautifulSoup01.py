...
string_html_data = """
<html>
    <head><meta charset="UTF-8"><title>網頁標題1</title></head>
    <body>
        <h1>文件標題1</h1>
        <h2>文件標題2</h2>
        <h3>文件標題3</h3>
        ...
        <div class="content">
            ...
            <a href="http://example.com/three" class="blue" id="link3"><br>
...
for _ in cc:
    print(_)
print("直接取出第1項的內容 :")
print(soup.find_all(["title", "p"])[4].text)
