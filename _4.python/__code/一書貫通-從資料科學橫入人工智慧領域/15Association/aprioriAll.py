...
def createLs1(dataSet, min_support):
    ...
    litemsets = apriori(flattenSet, minSupport=min_support_new)
...
"""
    一个更快速搜寻子序列的算法可参考： R. Agrawal and R. Srikant. Mining sequential patterns. Research Report RJ 9910, IBM Almaden Research Center, San Jose, California, Oc tober 1994.
