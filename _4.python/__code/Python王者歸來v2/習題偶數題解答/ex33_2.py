...
button1.pack()
button2 = Button(tk, text='暫停', width=10, command=pausemusic)   # 撥放mp3音樂
button2.pack()
button3 = Button(tk, text='恢復', width=10, command=unpausemusic) # 撥放mp3音樂
button3.pack()
button4 = Button(tk, text='結束', width=10, command=stopmusic)    # 停止撥放mp3音樂
button4.pack()
mainloop()
