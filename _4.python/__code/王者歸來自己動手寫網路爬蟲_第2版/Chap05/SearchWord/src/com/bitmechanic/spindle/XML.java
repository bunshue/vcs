...
/**
 * @author yonik
 * @version $Id: XML.java 472574 2006-11-08 18:25:52Z yonik $
 */
public class XML {
 ...
 * @throws IOException
 */
  public static void escapeCharData(String str, StringBuilder out) throws IOException {
    escape(str, out, chardata_escapes);
  }

  public static void escapeAttributeValue(String str, StringBuilder out) throws IOException {
    escape(str, out, attribute_escapes);
  }


  public final static void writeXML(StringBuilder out, String tag, String val) throws IOException {
    out.append('<');
    out.append(tag);
    if (val == null) {
      out.append("/>");
  ...
  public final static void writeXML(StringBuilder out, String tag, String val, Object... attrs) throws IOException {
    out.append('<');
    out.append(tag);
    for (int i=0; i<attrs.length; i++) {
      out.append(' ');
      out.append(attrs[i++].toString());
      out.append("=\"");
  ...
  private static void escape(String str, StringBuilder out, String[] escapes) throws IOException {
    int start=0;
    ...
    for (int i=start; i<str.length(); i++) {
      ...
      if (subst != null) {
        if (start<i) {
          out.append(str.substring(start,i));
