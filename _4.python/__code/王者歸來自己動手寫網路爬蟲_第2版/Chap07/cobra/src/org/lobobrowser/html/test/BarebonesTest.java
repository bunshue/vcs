...
public class BarebonesTest {
    ...
    {
    	//System.out.println("ñS¼ÃØÚæ¢Çä¡¼ôï?);
        if(
...
*/
        ...
        //System.out.println("îíÏAæíÚûûÄ¡¼®þú¦ûçÃsÝn¡¼ôï?);
        ...
        while (child != null)
        {
            ...
            //System.out.println("îíÏAæíæ¢Çä¡¼ôï¦cÕÚîãáDÖâ¡¼Ø\Ô`");
        }
        //System.out.println("ñS¼ÃØÚæ¢Çä¡¼ôï¦cÚé¡¼?);
