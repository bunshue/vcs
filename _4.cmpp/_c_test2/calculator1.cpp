...
");
  ...
  //測試區塊
  {
	...
	srand( (unsigned)time( NULL ) );	//完全random需加
...
已知要做W_AXH_A大小
則time_W_A=W_A/8;time_H_A=H_A;

spz blockA抓32X3 => W 4次，H 3次，共12次，有12個點
spz blockA抓WXH => time_W_A = W_A/8 次，time_H_A = H_A 次，共time_W_A*time_H_A次，有time_W_A*time_H_A個點
...
spz blockB抓32X2 => W 4次，H 2次，共8次，有8個點
block_B用到
...
已知要做W_BXH_B大小
則time_W_B=W_B/8;time_H_B=H_B;

spz blockB抓32X2 => W 4次，H 2次，共8次，有8個點
spz blockB抓WXH => time_W_B = W_B/8 次，time_H_B = H_B 次，共time_W_B*time_H_B次，有time_W_B*time_H_B個點
...
若不分even-odd時，
		...
		BA0=VMA*8;
		BA3=BA0+T/2;	//但永不可能BA3在BA0之前，或可交換
		//decide VMEM shape
