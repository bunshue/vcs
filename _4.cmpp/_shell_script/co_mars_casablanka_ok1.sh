...
SvnImgAvhddURL="http://cadinfo/svn/col/DVR/mars/software/system/flash_environment/develop/image_file_avhdd_v2"
...
#SvnSystemURL="http://cadinfo.realtek.com.tw/svn/col/DVR/branches/software_DTV_Rebecca/"
SvnMarsComURL="http://cadinfo/svn/col/DVR/mars/software"
sqaBranchURL="http://cadinfo/svn/col/DVR/branches/SQA/Mars_Casablanca_Branch"
...
imgAvhddPath="$rootdir/svn/system/flash_environment/develop/image_file_avhdd_v2"
...
linuxSrcVer=`svn log $vns_AVHDD_Linux_Nand_URL | head -5 | grep "MARS_AVHDD" | cut -d ":" -f2 | cut -d "," -f1`
...
#    cp -f include/MakeConfig.PLAYER.MARS.REBECCA include/MakeConfig
    cp -f include/MakeConfig.PLAYER.MARS.CASABLANCA include/MakeConfig
    ...
    svn checkout $SvnImgAvhddURL image_file_avhdd_v2
...
#==========Config Make Release completed========
  ...
  if [ "$1" == "release" ]; then
	...
	NewURL="LIVEUPDATE_URL=http:\/\/172.21.98.57\/korsen\/theaterappliance.xml"
...
#      resultPath=$scriptDir/Casablanca_Result/"$verStr"
#      mkdir -p $resultPath
#      cp install.img $resultPath
	...
	echo "IMS            :$IMS_Ver" >> Version_Casablanca.txt
       ...
       cp install.img Version_Casablanca.txt /mnt/46/korsen/Casablanca/"$verStr"
