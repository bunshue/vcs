...
class MenuDemo:
    def __init__(self):
        ...
        # Create images
        plusImage = PhotoImage(file = "C:/book/image/plus.gif")
        minusImage = PhotoImage(file = "C:/book/image/minus.gif")
        timesImage = PhotoImage(file = "C:/book/image/times.gif")
        divideImage = PhotoImage(file = "C:/book/image/divide.gif")
