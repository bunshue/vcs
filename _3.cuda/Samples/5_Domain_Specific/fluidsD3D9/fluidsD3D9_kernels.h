...
__global__ void advectVelocity_k(cData* v, float* vx, float* vy, int dx, int pdx, int dy, float dt, int lb, cudaTextureObject_t tex);
...
__global__ void advectParticles_k(Vertex* part, cData* v, int dx, int dy, float dt, int lb, size_t pitch);
