...
__global__ void cuda_kernel_update(float2* newPos, float2* curPos, uint numBirds, bool* hasproxy,
    bool* neighbors, bool* rightgoals, bool* leftgoals, Params* params)
{
...
__global__ void cuda_kernel_checktriples(float2* pos, uint numBirds, bool* hasproxy, bool* neighbors,
    bool* rightgoals, bool* leftgoals, uint3* triples, Params* params)
{
...
__global__ void cuda_kernel_checkpairs(float2* pos, uint numBirds, bool* hasproxy, bool* neighbors,
    bool* rightgoals, bool* leftgoals, uint2* pairs, Params* params)
{
    uint i = blockIdx.x * blockDim.x + threadIdx.x;
...
extern "C" void cuda_simulate(float2 * newPos, float2 * curPos, uint numBirds, bool* d_hasproxy, bool* d_neighbors,
