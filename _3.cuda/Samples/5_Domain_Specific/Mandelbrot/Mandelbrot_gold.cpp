...
void RunMandelbrotGold1(uchar4* dst, const int imageW, const int imageH,
    ...
    const int animationFrame, const bool isJulia)
{
    runMandelbrotGold1<float, float>(dst, imageW, imageH, crunch, xOff, yOff, xJParam, yJParam, scale, colors, frame, animationFrame, isJulia);
}  // RunMandelbrotGold1
...
void RunMandelbrotDSGold1(uchar4* dst, const int imageW, const int imageH,
    ...
    const int animationFrame, const bool isJulia)
{
    runMandelbrotGold1<double, dfloat>(dst, imageW, imageH, crunch, xOff, yOff, xJParam, yJParam, scale, colors, frame, animationFrame, isJulia);
...
void RunMandelbrotGold0(uchar4* dst, const int imageW, const int imageH,
    ...
    const int animationFrame, const bool isJulia)
{
    runMandelbrotGold0<float, float>(dst, imageW, imageH, crunch, xOff, yOff, xJParam, yJParam, scale, colors, frame, animationFrame, isJulia);
}  // RunMandelbrotGold0
...
void RunMandelbrotDSGold0(uchar4* dst, const int imageW, const int imageH,
    ...
    const uchar4 colors, const int frame,
    const int animationFrame, const bool isJulia) {
    runMandelbrotGold0<double, dfloat>(dst, imageW, imageH, crunch, xOff, yOff, xJParam, yJParam, scale, colors, frame, animationFrame, isJulia);
