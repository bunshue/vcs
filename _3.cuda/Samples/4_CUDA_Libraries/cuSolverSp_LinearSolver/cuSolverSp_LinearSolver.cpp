...
int main(int argc, char* argv[])
{
    ...
    checkCudaErrors(cusolverSpXcsrperm_bufferSizeHost(handle, rowsA, colsA, nnzA, descrA, h_csrRowPtrB, h_csrColIndB, h_Q, h_Q, &size_perm));
    ...
    /* Q*x = z */
    checkCudaErrors(cusparseDsctr(cusparseHandle, rowsA, d_z, d_Q, d_x, CUSPARSE_INDEX_BASE_ZERO));
    checkCudaErrors(cudaDeviceSynchronize());
