...
* It also shows how to correctly templatize dynamically allocated shared memory arrays.
* Host code.
*/
...
void runTest(int argc, char** argv, int len)
{
    ...
    checkCudaErrors(cuLaunchKernel(kernel_addr, grid.x, grid.y, grid.z, /* grid dim */
