...
int main(int argc, char** argv)
{
    ...
    checkCudaErrors(cudaMalloc(reinterpret_cast<void**>(&d_input), VOTE_DATA_GROUP * warp_size * sizeof(unsigned int)));
    checkCudaErrors(cudaMalloc(reinterpret_cast<void**>(&d_result), VOTE_DATA_GROUP * warp_size * sizeof(unsigned int)));
