    ...
    if (ix < imageW && iy < imageH)
    {
        ...
        for (float i = -KNN_WINDOW_RADIUS; i <= KNN_WINDOW_RADIUS; i++)
            for (float j = -KNN_WINDOW_RADIUS; j <= KNN_WINDOW_RADIUS; j++)
            {
                ...
                // Update weight counter, if KNN weight for current window texel exceeds the weight threshold
        ...
        // Choose LERP quotient basing on how many texels within the KNN window exceeded the weight threshold
