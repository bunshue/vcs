...
periphs_gpio_t periphs_gpio_inst;

void scutimer_IntrHandler(void *CallBackRef);


#define BUF_LENGTH 10
u8 input_buffer[BUF_LENGTH];
u8 input_buffer_index;
u8 flag_updata_input_buffer;
uint32_t flag_is_keyboard_mounted;
uint32_t keyboard_mounted_cnt;
