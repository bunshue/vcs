...
//				break;
			...
			case 'y':
				...
				break;
			case 'u':
				xil_printf("\n\rPark/Unpark Camera Freeze VDMA.\n\r");


				periphs_toggle_camera_freeze_vdma(&periphs_inst);	//freeze-defreeze main picture
				...
				xil_printf("\n\r\n\r");
				//	show/hide small picture
				if (periphs_inst.enable_camera_freeze_vdma == PERIPHS_SEL_ENABLE_PARK)		//1
				{
					xil_printf("Park, XVMix_LayerEnable\n\r");
					XVMix_LayerEnable(periphs_inst.p_vid_output_mixer_l2_inst, XVMIX_LAYER_2);
				}
				else 	//periphs_inst.enable_camera_freeze_vdma == PERIPHS_SEL_DISABLE_PARK	//0
				{
...
//				break;
			...
			case 'v':
				...
				status = XAxiVdma_DmaStart((&periphs_inst)->p_vdma_camera_inst, XAXIVDMA_WRITE);
