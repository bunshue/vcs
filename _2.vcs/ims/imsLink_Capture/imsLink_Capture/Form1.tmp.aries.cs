...
namespace imsLink_Capture
{
    public partial class Form1 : Form
    {
        bool flag_show_time = false;     //顯示時間
        bool flag_show_grid = false;     //顯示格線
        bool flag_invert = true;        //反相, SC700需要反相
        ...
        void save_image_file()
        {
            ...
            if (bitmap1 != null)
            {
                ...
                try
                {
                    ...
                    show_main_message("已存檔 JPG", S_OK, 10);
                }
                catch (Exception ex)
                {
