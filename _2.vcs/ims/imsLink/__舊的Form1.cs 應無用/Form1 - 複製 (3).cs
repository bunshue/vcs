    ...
    public partial class Form1 : Form
    {
        ...
        void show_awb_item_visible(bool en)
        {
            ...
            if (flag_operation_mode != MODE_RELEASE_STAGE0)
            {
                ...
                bt_find_brightness2.Visible = false;
        ...
        void show_item_location()
        {
            ...
            bt_awb_test3.Location = new Point(1680, 440);
            ...
            else
            {
                ...
                bt_find_brightness.Location = new Point(comboBox_sharpness.Location.X + 55, comboBox_sharpness.Location.Y - 300);
                bt_find_brightness2.Location = new Point(comboBox_sharpness.Location.X + 55, comboBox_sharpness.Location.Y - 250);
        ...
        */
        ...
        {
            if (flag_awb_auto_find_location == true)
                return;
            ...
            //{
                ...
                */
                ...
                gg.FillRectangle(new SolidBrush(Color.Yellow), 550, 347 + (255 - th_l) / 4, 18, (th_l / 4));
            ...
            */
            ...
            while(true)
            {
                ...
                if (flag_break == false)
                {
                    ...
                    pictureBox1.Image = bm2;
                    delay(1000);
                    richTextBox1.Text += "call refresh_picturebox2\n";
                    delay(1000);
                    refresh_picturebox2();
                    delay(1000);
