...
namespace imsLink
{
    public partial class Form1 : Form
    {
        ...
        int flag_operation_mode = MODE_RELEASE_STAGE1A;  //不允許第四, 第七, 第八
        ...
        */
        ...
        void Cam_NewFrame(object sender, NewFrameEventArgs eventArgs)
        {
            ...
            else if ((cb_show_grid.Checked == true) && (flag_enaglb_awb_function == true))
            {
                ...
                gg.DrawLine(PenStyle, w / 2 - 140, h / 2, w / 2 + 140, h / 2);
                gg.DrawLine(PenStyle, w / 2, h / 2 - 140, w / 2, h / 2 + 140);
                ...
                for (www = awb_block; www <= 192; www += awb_block)
                {
                    ...
                    gg.DrawRectangle(PenStyle, x_st, y_st, www, hhh);
                }
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            if (bitmap1 != null)
            {
                ...
                {
                    filename1 = "M:\\" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + "_" + tb_sn_opal.Text + "_1a";
                    filename2 = Application.StartupPath + "\\picture\\" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + "_" + tb_sn_opal.Text + "_1a";
                }
                else if (flag_operation_mode == MODE_RELEASE_STAGE1B)
                {
                    filename1 = "M:\\" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + "_" + tb_sn_opal.Text + "_1b";
        ...
        */
        ...
        private void timer_stage9_Tick(object sender, EventArgs e)
        {
            ...
            if ((cnt3++ % 3) == 0)
            {
                ...
                if ((flag_ok_data1 == false) && (flag_ok_data1 == false))
                {
                    ...
                    {
                        if (this.tb_sale1.Focused == false)
                            tb_sale1.Focus();
                    }
                }
        ...
        private void button63_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (this.tb_sale3.Focused == false)
                        tb_sale3.Focus();
        ...
        void awb_test_auto(object sender, EventArgs e, int dx, int dy)
        {
            flag_right_left_cnt = dx;
            flag_down_up_cnt = dy;
            refresh_picturebox2();
            delay(100);
