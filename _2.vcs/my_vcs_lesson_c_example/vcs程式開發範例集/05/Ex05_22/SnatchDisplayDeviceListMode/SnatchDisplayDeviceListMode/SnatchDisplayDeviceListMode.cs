...
{
    public partial class SnatchDisplayDeviceListMode : Form
    {
        public SnatchDisplayDeviceListMode()
        {
            InitializeComponent();
        }
        ...
        private void snatch_Click(object sender,EventArgs e)
        {
            ...
            {
                unhideMode.Text = ListModeObject["VideoModeDescription"].ToString(); //在文本框中显示设备的当前显示模式
            }
