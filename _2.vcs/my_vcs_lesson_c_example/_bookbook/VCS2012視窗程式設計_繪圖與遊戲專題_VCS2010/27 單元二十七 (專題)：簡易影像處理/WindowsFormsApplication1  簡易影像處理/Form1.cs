...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            pictureBox2.BackgroundImage = ConvertToGrayscale(pictureBox1.BackgroundImage);
        }
        ...
        {
            pictureBox2.BackgroundImage = ConvertToGrayscale_CM(pictureBox1.BackgroundImage);
        }
        ...
        {
            pictureBox2.BackgroundImage = ConvertToTransparency(pictureBox1.BackgroundImage);
        }
        ...
        {
            pictureBox2.BackgroundImage = ConvertToRotate(pictureBox1.BackgroundImage);
        }
        ...
        {
            pictureBox2.BackgroundImage = ImageAddText(pictureBox1.BackgroundImage);
        }
        ...
        public Bitmap ImageAddText(Image image)
        {
            Bitmap dest = new Bitmap(image.Width, image.Height);
            Graphics g = Graphics.FromImage(dest);
            Font fn = new Font("標楷體", 20);

            g.DrawImage(image, new Rectangle(0, 0, image.Width, image.Height));
            g.DrawString("Picasso", fn, Brushes.Red, 30, 0, StringFormat.GenericTypographic);
            g.Dispose();
