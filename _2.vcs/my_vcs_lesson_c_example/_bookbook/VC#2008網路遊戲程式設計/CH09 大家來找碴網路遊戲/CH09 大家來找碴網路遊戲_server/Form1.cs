...
namespace 大家來找碴網路遊戲_server
{
    public partial class Form1 : Form
    {
        ...
        private void ClientService() //這個副程式，乃是無限迴圈中偵測是否有Client傳送訊息
        {
            ...
            int ii, name = 0, score = 0, count_temp = 0, win = 0 , lose = 0;
            string strAll = "";
            Socket socketTemp;
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    else  // 有人進來時
                    {
                        ...
                        if ((name == 1) && (strAll != "") && (strAll != "name") && (strAll != "win") && (strAll != "lose"))
                        {
                        ...
                        if ((strAll != "win") && (strAll != "") && (win == 1) && (strAll != "name") && (strAll != "lose"))
                        {
                            win = 0;
                         ...
                         if (strAll == "lose")
                        {
                         ...
                         if ((strAll != "lose") && (strAll != "") && (lose == 1) && (strAll != "name") && (strAll != "win"))
                        {
                            lose = 0;
