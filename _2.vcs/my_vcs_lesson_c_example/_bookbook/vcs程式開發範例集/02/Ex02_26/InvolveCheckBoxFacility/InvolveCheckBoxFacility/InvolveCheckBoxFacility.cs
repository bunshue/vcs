...
{
    public partial class InvolveCheckBoxFacility : Form
    {
        public InvolveCheckBoxFacility()
        {
            InitializeComponent();
        }

        private void InvolveCheckBoxFacility_Load(object sender, EventArgs e)
        {
            ...
            foreach (String fileName in Directory.GetFiles("C:\\"))//循環遍歷C盤的內容
            {
        ...
        private void cleanUp_Click(object sender, EventArgs e)
        {
            foreach (ListViewItem tempItem in listView1.Items)//循環遍歷listView控件中的每一項
            {
                if (tempItem.Checked)//如果當前項處於選中狀態
                {
