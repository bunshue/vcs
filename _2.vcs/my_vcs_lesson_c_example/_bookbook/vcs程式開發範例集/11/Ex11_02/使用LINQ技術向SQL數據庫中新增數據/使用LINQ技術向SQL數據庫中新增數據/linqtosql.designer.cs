...
namespace 使用LINQ技術向SQL數據庫中新增數據
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="db_11")]
    ...
    partial void Deletetb_User(tb_User instance);
        ...
        base(global::使用LINQ技術向SQL數據庫中新增數據.Properties.Settings.Default.db_11ConnectionString, mappingSource)
		{
			OnCreated();
		}
