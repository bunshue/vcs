    ...
    public partial class Form1 : Form
    {
        ...
        public void GetVox()
        {
            ...
            if (System.IO.File.Exists(Application.StartupPath + "\\Tem_File.ini") == true)
            {
                ...
                {
                    GetPrivateProfileString("Vox", i.ToString(), "數據讀取錯誤。", temp, 255, Application.StartupPath + "\\Tem_File.ini");
        ...
        private void pict_Back_Click(object sender, EventArgs e)
        {
            ...
            switch (tem_Value)
            {
                case "0": num(tem_Value); sound(VoxPath[0]); break;//完成按鈕的語音功能
                ...
                case "+-":
                    {
                        ...
                        if (Convert.ToInt32(textBox1.Text) > 0)//如果目前為正數
                            sound(VoxPath[21]);//完成正數發音
                        else
                            sound(VoxPath[22]);//完成負數發音
                        break;
                    }
