...
namespace CH0707
{
    ...
    {
        //定義靜態方法-名稱、生日、身高、性別
        static void showInfo(string name, DateTime birth, ushort height, bool sex_is)
        {
            ...
            Console.WriteLine("{sex}! {name}");
            Console.WriteLine("年齡 {age} 身高 {height}cm");
        }
        ...
        static void Main(string[] args)
        {
            ...
            //呼叫靜態方法，具名指定引數
            showInfo(height: ht1, name: boy, sex_is: true, birth: bth1);

            showInfo(birth: bth2, name: girl, height: ht2, sex_is: false);
