...
namespace CH0708
{
    class Worker
    {
        ...
        //定義方法-4個參數，預設值為0
        void Salary(uint pay = 0, float tax = 0.0F, uint insur1 = 0, uint insur2 = 0)
        {
            ...
            Console.WriteLine("{name,-11}, 實薪 {outcome:c0}");
        }

        static void Main(string[] args)
        {
            Worker wk1 = new Worker("Amanda");
            wk1.Salary(25000);   //只有一個引數

            Worker wk2 = new Worker("Peter Pan");
            wk2.Salary(29500, 529, 355);

            Worker wk3 = new Worker("Charles");
            wk3.Salary(35400, 0.08F, 700, 469);
