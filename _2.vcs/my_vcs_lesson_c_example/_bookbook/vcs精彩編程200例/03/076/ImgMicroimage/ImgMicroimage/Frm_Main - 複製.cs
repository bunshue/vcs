...
namespace ImgMicroimage
{
    public partial class Frm_Main : Form
    {
        ...
        private void a()
        {
            ...
            DirectoryInfo di2 = new DirectoryInfo("C:\\______test_files\\_pic_thumbnail");
            for (int i = 0; i < fi.Length; i++)
            {
                ...
                if (imgType.ToLower() == "jpeg" || imgType.ToLower() == "gif" || imgType.ToLower() == "png" || imgType.ToLower() == "jpg" || imgType.ToLower() == "bmp")
                {
                    ...
                    if (!di2.Exists)
                    {
                        Directory.CreateDirectory("C:\\______test_files\\_pic_thumbnail");
                        if (GetReducedImage(percent, "C:\\______test_files\\_pic_thumbnail\\_" + imgName + ".JPG"))
                        {
                            imageList1.Images.Add(i.ToString(), Image.FromFile("C:\\______test_files\\_pic_thumbnail\\_" + imgName + ".JPG"));
                            a[0] = imgName + "." + imgType;
        ...
        {
            folderBrowserDialog1.SelectedPath = "C:\\______test_files\\_pic";
        ...
        private void deletefile()
        {
            try
            {
                ...
                if (di2.Exists)
                {
                    ...
                    fso.DeleteFolder("C:\\______test_files\\_pic_thumbnail", true);
                }
            }
            catch
            {
