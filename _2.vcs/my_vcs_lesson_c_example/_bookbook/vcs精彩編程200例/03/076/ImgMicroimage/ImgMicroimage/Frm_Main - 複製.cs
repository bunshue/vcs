...
namespace ImgMicroimage
{
    public partial class Frm_Main : Form
    {
        ...
        private void a()
        {
            ...
            DirectoryInfo di2 = new DirectoryInfo(@"D:\_git\vcs\_1.data\______test_files1\_pic_thumbnail");
            for (int i = 0; i < fi.Length; i++)
            {
                ...
                if (imgType.ToLower() == "jpeg" || imgType.ToLower() == "gif" || imgType.ToLower() == "png" || imgType.ToLower() == "jpg" || imgType.ToLower() == "bmp")
                {
                    ...
                    if (!di2.Exists)
                    {
                        Directory.CreateDirectory(@"D:\_git\vcs\_1.data\______test_files1\_pic_thumbnail");
                        if (GetReducedImage(percent, @"D:\_git\vcs\_1.data\______test_files1\_pic_thumbnail\_" + imgName + ".JPG"))
                        {
                            imageList1.Images.Add(i.ToString(), Image.FromFile(@"D:\_git\vcs\_1.data\______test_files1\_pic_thumbnail\_" + imgName + ".JPG"));
                            a[0] = imgName + "." + imgType;
        ...
        private void deletefile()
        {
            try
            {
                ...
                if (di2.Exists)
                {
                    ...
                    fso.DeleteFolder(@"D:\_git\vcs\_1.data\______test_files1\_pic_thumbnail", true);
                }
            }
            catch
            {
