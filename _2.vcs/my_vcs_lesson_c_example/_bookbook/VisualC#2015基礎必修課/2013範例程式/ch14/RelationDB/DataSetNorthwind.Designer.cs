...
namespace RelationDB {
    ...
    public partial class DataSetNorthwind : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_產品資料_產品類別;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_產品資料_產品類別 = this.Relations["FK_產品資料_產品類別"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_產品資料_產品類別 = new global::System.Data.DataRelation("FK_產品資料_產品類別", new global::System.Data.DataColumn[] {
                        this.table產品類別.類別編號Column}, new global::System.Data.DataColumn[] {
                        this.table產品資料.類別編號Column}, false);
            this.Relations.Add(this.relationFK_產品資料_產品類別);
        }
        ...
        public partial class 產品資料DataTable : global::System.Data.TypedTableBase<產品資料Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public 產品資料Row Add產品資料Row(string 產品, int 供應商編號, 產品類別Row parent產品類別RowByFK_產品資料_產品類別, string 單位數量, decimal 單價, short 庫存量, short 已訂購量, short 安全存量, bool 不再銷售) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        安全存量,
                        不再銷售};
                if ((parent產品類別RowByFK_產品資料_產品類別 != null)) {
                    columnValuesArray[3] = parent產品類別RowByFK_產品資料_產品類別[0];
                }
        ...
        public partial class 產品資料Row : global::System.Data.DataRow {
            ...
            public 產品類別Row 產品類別Row {
                get {
                    return ((產品類別Row)(this.GetParentRow(this.Table.ParentRelations["FK_產品資料_產品類別"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_產品資料_產品類別"]);
                }
            }
        ...
        public partial class 產品類別Row : global::System.Data.DataRow {
            ...
            public 產品資料Row[] Get產品資料Rows() {
                if ((this.Table.ChildRelations["FK_產品資料_產品類別"] == null)) {
                    return new 產品資料Row[0];
                }
                else {
                    return ((產品資料Row[])(base.GetChildRows(this.Table.ChildRelations["FK_產品資料_產品類別"])));
                }
            }
        }
