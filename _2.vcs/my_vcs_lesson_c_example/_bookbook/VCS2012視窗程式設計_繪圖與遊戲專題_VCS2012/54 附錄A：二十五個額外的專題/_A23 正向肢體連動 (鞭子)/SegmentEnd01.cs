...
// 這是為了 鞭子 的手把 特定更改的 Segment 類別
// 手把 的左端 延伸 半個寬
namespace WindowsApplication1
{
    class SegmentEnd01  // 肢節 的 類別
    {
        ...
        public SegmentEnd01(int Width, int Height, Color color)
        {
        ...
        public void Draw(Graphics G)
        {
            ...
            rect.X = -size.Height / 2 - size.Width / 2;  // <==== 手把 的左端 延伸 半個寬
            rect.Y = -size.Height / 2;
            rect.Width = (int)(1.5 * size.Width + size.Height); // <==== 手把 的左端 延伸 半個寬
