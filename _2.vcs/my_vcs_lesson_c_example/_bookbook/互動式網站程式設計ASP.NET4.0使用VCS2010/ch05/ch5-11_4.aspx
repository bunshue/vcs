<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch5-11_4.aspx.cs" Inherits="ch5_1" %>
...
<body>
    ...
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="3" BackColor="#EFF3FB" 
        ...
        Height="136px" onfinishbuttonclick="Wizard1_FinishButtonClick" Width="249px">
        ...
        <WizardSteps>
            ...
            <asp:WizardStep runat="server" Title="Step 3">
                學員密碼：<asp:TextBox ID="TextBox4" runat="server" TextMode="Password" Width="69px"></asp:TextBox>
                <br />
                再輸一次：<asp:TextBox ID="TextBox5" runat="server" TextMode="Password" Width="69px"></asp:TextBox>
            </asp:WizardStep>
