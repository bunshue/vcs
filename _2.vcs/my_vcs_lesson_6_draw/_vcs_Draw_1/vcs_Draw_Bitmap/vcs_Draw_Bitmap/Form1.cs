...
namespace vcs_Draw_Bitmap
{
    public partial class Form1 : Form
    {
        ...
        void open_new_file()
        {
            richTextBox1.Text += "開啟一個 1080 X 840 的空畫布\n";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            string filename = @"D:\_git\vcs\_2.vcs\my_vcs_lesson_6_draw\data\rgb1.png";
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            string filename1 = @"D:\_git\vcs\_1.data\______test_files1\__pic\_anime\_angry_bird\AB_red.jpg";

            Bitmap bitmap1 = new Bitmap(filename);

            Graphics g = Graphics.FromImage(bitmap1);

            richTextBox1.Text += "水平解析度\t" + g.DpiX.ToString() + " dpi\n";
            richTextBox1.Text += "垂直解析度\t" + g.DpiY.ToString() + " dpi\n";
