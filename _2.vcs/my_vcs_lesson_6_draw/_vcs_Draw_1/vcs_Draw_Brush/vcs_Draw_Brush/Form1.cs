...
namespace vcs_Draw_Brush
{
    public partial class Form1 : Form
    {
        ...
        private void button0_Click(object sender, EventArgs e)
        {
            ...
            string filename = @"D:\_git\vcs\_1.data\______test_files1\_icon\唐.ico";
        ...
        public void draw_TextureBrush()
        {
            ...
            string filename = @"D:\_git\vcs\_1.data\______test_files1\picture1.jpg";  //使用一張背景圖
   ...
   Color.FromArgb(255, 0, 0, 255));  // Opaque blue
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            //用圖片填充
            TextureBrush b2 = new TextureBrush(Image.FromFile(@"D:\_git\vcs\_1.data\______test_files1\picture1.jpg"));
