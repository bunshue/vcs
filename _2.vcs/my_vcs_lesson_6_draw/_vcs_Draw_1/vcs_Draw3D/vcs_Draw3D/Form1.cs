...
namespace vcs_Draw3D
{
    public partial class Form1 : Form
    {
        int W = 250;
        int H = 250;
        int pictureBox12_position_x = 0;
        int pictureBox12_position_y = 0;
        ...
        void show_item_location()
        {
            ...
            pictureBox11.Size = new Size(280, 200);
            ...
            pictureBox12_position_x = x_st + dx * 2;
            pictureBox12_position_y = y_st + dy * 2;
        ...
        {
            string filename = @"D:\_git\vcs\_1.data\______test_files1\__RW\_png\scale16X16.png";
        ...
        {
            int W = pictureBox11.ClientSize.Width;
            int H = pictureBox11.ClientSize.Height;
            int max = 0;
            int min = 255;
            int total = 0;
            int average = 0;
        ...
        {
            int x_st = pictureBox12_position_x;
            int y_st = pictureBox12_position_y;
            int WIDTH = 25;
