...
namespace vcs_Draw9_Example5b_vcsh
{
    public partial class Form1 : Form
    {
        ...
        //Buddhabrot_佛像碎形是一個曼德博集合的碎形呈現技術
        ...
        private void bt_draw_buddhabrot_Click(object sender, EventArgs e)
        {
            if (bt_draw_buddhabrot.Text == "Draw")
            {
                bt_draw_buddhabrot.Text = "Stop";
                DrawBrot();
            }

            IsDrawing = false;
            bt_draw_buddhabrot.Text = "Draw";
        }
        ...
        private void DrawBrot()
        {
            ...
            pictureBox2.Image = BrotBitmap;
            this.ClientSize = new Size(
                pictureBox2.Left + pictureBox2.Width + 8,
                System.Math.Max(
                    bt_draw_buddhabrot.Top + bt_draw_buddhabrot.Height,
                    pictureBox2.Top + pictureBox2.Height) + 8);
