...
namespace vcs_Draw3A
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //for pictureBox_random_2d_array ST
            pictureBox_random_2d_array.Location = new Point(10, 500);
            pictureBox_random_2d_array.Size = new Size(280, 200);
            pictureBox_random_2d_array.BackColor = Color.Pink;
        ...
        {
            int W = pictureBox_random_2d_array.ClientSize.Width;
            int H = pictureBox_random_2d_array.ClientSize.Height;
            int max = 0;
            int min = 255;
            int total = 0;
            int average = 0;
        ...
        private void timer_random_2d_array_Tick(object sender, EventArgs e)
        {
