    ...
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            */
            ...
            if (use_pig_kind == 0)
            {
                bmp = new Bitmap(@"C:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig1.jpg");
            }
            else if (use_pig_kind == 1)
            {
                bmp = new Bitmap(@"C:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig2.jpg");
            }
            else if (use_pig_kind == 2)
            {
                bmp = new Bitmap(@"C:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig3.jpg");
            }
            else if (use_pig_kind == 3)
            {
                bmp = new Bitmap(@"C:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig4.jpg");
            }
            else
            {
                bmp = new Bitmap(@"C:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig1.jpg");
