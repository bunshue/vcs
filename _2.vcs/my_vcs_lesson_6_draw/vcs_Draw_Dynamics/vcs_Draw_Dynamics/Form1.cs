...
namespace vcs_Draw_Dynamics
{
    public partial class Form1 : Form
    {
        ...
        void show_item_location()
        {
            ...
            pictureBox_bird.BackColor = Color.White;
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            */
            ...
            if (rb1.Checked == true)
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_red.jpg");
            else if (rb2.Checked == true)
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_yellow.jpg");
            else if (rb3.Checked == true)
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_blue.jpg");
            else if (rb4.Checked == true)
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_black.jpg");
            else
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_red.jpg");
            ...
            if (use_pig_kind == 0)
            {
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig1.jpg");
            }
            else if (use_pig_kind == 1)
            {
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig2.jpg");
            }
            else if (use_pig_kind == 2)
            {
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig3.jpg");
            }
            else if (use_pig_kind == 3)
            {
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig4.jpg");
            }
            else
            {
                bmp = new Bitmap(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_pig1.jpg");
        ...
        private void rb_bird_CheckedChanged(object sender, EventArgs e)
        {
            if (rb1.Checked == true)
            {
                ...
                pictureBox_bird.Image = Image.FromFile(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_red.jpg");
                mass = 1;
                use_bird_kind = 0;
            }
            else if (rb2.Checked == true)
            {
                ...
                pictureBox_bird.Image = Image.FromFile(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_yellow.jpg");
                mass = 0.6f;
                use_bird_kind = 1;
            }
            else if (rb3.Checked == true)
            {
                ...
                pictureBox_bird.Image = Image.FromFile(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_blue.jpg");
                mass = 0.3f;
                use_bird_kind = 2;
            }
            else if (rb4.Checked == true)
            {
                ...
                pictureBox_bird.Image = Image.FromFile(@"D:\_git\vcs\_1.data\______test_files1\__pic\_angry_bird\AB_black.jpg");
                mass = 2;
                use_bird_kind = 3;
            }
            else
