...
namespace vcs_Draw9_Example6_vcsh_math
{
    public partial class Form1 : Form
    {
        ...
        void show_item_location()
        {
            ...
            pictureBox13.Size = new Size(W * 2, H);
            pictureBox16.Size = new Size(W+50, H);
            ...
            groupBox1.Location = new Point(x_st + dx * 2, y_st + dy * 2);
            groupBox2.Location = new Point(x_st + dx * 2, y_st + dy * 2+170);

            pictureBox16.Location = new Point(x_st + dx * 3-50, y_st + dy * 2);
        ...
        {
            GraphImage = new Bitmap(pictureBox13.ClientSize.Width, pictureBox13.ClientSize.Height);
            using (Graphics gr = Graphics.FromImage(GraphImage))
            {
                ...
                using (Pen thin_pen = new Pen(Color.Purple, 0))
                {
                    ...
                    {
                        new PointF(0, 0),
                        new PointF(pictureBox13.ClientSize.Width, 0),
                        new PointF(0, pictureBox13.ClientSize.Height),
                    };
        ...
        private void btnDraw_Click(object sender, EventArgs e)
        {
            ...
            // Make a bitmap.
            Bitmap bm = new Bitmap(pictureBox16.ClientSize.Width, pictureBox16.ClientSize.Height);
            using (Graphics gr = Graphics.FromImage(bm))
            {
                gr.SmoothingMode = SmoothingMode.AntiAlias;
                ...
                {
                    new PointF(0, pictureBox16.ClientSize.Height),
                    new PointF(pictureBox16.ClientSize.Width, pictureBox16.ClientSize.Height),
                    new PointF(0, 0),
                };
                ...
                using (Pen pen = new Pen(Color.Red, 0))
                {
                    using (Font font = new Font("Arial", 8))
                    {
                        ...
                        float dx = (wxmax - wxmin) / pictureBox16.ClientSize.Width;
