...
namespace vcs_MousePaint7
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // 內嵌的滑鼠游標圖形, 把 3dgarro.cur 設定為 內嵌資源+永遠複製
        ...
        void show_item_location()
        {
            ...
            label1a.Location = new Point(x_st + dx * 1 + 20, y_st + dy * 0 + H - 30);
            label1b.Location = new Point(x_st + dx * 1 + 150, y_st + dy * 0 + H - 30);
