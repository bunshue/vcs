...
namespace vcs_Draw9_Example8_vcsh
{
    public partial class Form1 : Form
    {
        ...
        void show_item_location()
        {
            ...
            pictureBox_one_self_avoiding_walk.Size = new Size(W, H);
            ...
            pictureBox_one_self_avoiding_walk.Location = new Point(x_st + dx * 1, y_st + dy * 3);
        ...
        void start_one_self_avoiding_walk()
        {
            ...
            timer_one_self_avoiding_walk.Enabled = true;
        }
        ...
        private void timer_one_self_avoiding_walk_Tick(object sender, EventArgs e)
        {
