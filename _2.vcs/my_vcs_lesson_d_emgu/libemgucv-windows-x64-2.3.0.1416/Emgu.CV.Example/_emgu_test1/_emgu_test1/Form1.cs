...
namespace _emgu_test1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //string filename = @"C:\______test_files1\pic_256X100.jpg";
            string filename = @"C:\______test_files1\pic_256X100b.bmp";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            filenamej = @"C:\______test_files1\__pic\_MU\id_card_01.jpg";
            ...
            filenamej = @"C:\______test_files1\__pic\_MU\id_card_02.jpg";
            pictureBox1.Image = Image.FromFile(filenamej);
            img = new Image<Bgr, byte>(filenamej);
            video.WriteFrame<Bgr, byte>(img); //將每張圖片製作成影片
            Application.DoEvents();
            ...
            filenamej = @"C:\______test_files1\__pic\_MU\id_card_03.jpg";
            pictureBox1.Image = Image.FromFile(filenamej);
            img = new Image<Bgr, byte>(filenamej);
            video.WriteFrame<Bgr, byte>(img); //將每張圖片製作成影片
            Application.DoEvents();
            ...
            filenamej = @"C:\______test_files1\__pic\_MU\id_card_04.jpg";
            pictureBox1.Image = Image.FromFile(filenamej);
            img = new Image<Bgr, byte>(filenamej);
            video.WriteFrame<Bgr, byte>(img); //將每張圖片製作成影片
            Application.DoEvents();
            ...
            filenamej = @"C:\______test_files1\__pic\_MU\id_card_05.jpg";
            pictureBox1.Image = Image.FromFile(filenamej);
            img = new Image<Bgr, byte>(filenamej);
            video.WriteFrame<Bgr, byte>(img); //將每張圖片製作成影片
            Application.DoEvents();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            string filename = @"C:\______test_files1\_emgu\pic3.png";
