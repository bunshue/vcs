...
namespace vcs_ID3Tag
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //openFileDialog1.InitialDirectory = "c:\\______test_files1\\_id3";  //預設開啟的路徑
        ...
        {
            string filename = @"C:\______test_files1\_id3\aaaa.mp3";       //一定要有@
            encoding = "big5";
            get_ID3Tag(filename, encoding);
        }
        ...
        {
            string filename = @"C:\______test_files1\_id3\uramachi.mp3";       //一定要有@
            encoding = "gb2312";
            get_ID3Tag(filename, encoding);
        }
        ...
        {
            string filename = @"C:\______test_files1\_id3\harumi.mp3";       //一定要有@
            encoding = "shift_jis";
            get_ID3Tag(filename, encoding);
        }
        ...
        {
            string filename = @"C:\______test_files1\_id3\unicode_ナレーション(岡本妙子).mp3";       //一定要有@
            encoding = "big5";
            get_ID3Tag(filename, encoding);
        }
