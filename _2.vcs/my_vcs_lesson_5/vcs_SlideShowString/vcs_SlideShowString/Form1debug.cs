    ...
    public partial class Form1 : Form
    {
        ...
        void slide_show_string()
        {
            ...
            */
            ...
            richTextBox1.Text += "x1 = " + (0 + show_waist_size * 3 + show_max_height_size * 2).ToString() + " y1 = " + show_head_size.ToString() + "\n";
            richTextBox1.Text += "x2 = " + (0 + show_waist_size * 2 + show_max_height_size).ToString() + " y2 = " + show_head_size.ToString() + "\n";
            richTextBox1.Text += "x3 = " + (0 + show_waist_size).ToString() + " y3 = " + show_head_size.ToString() + "\n";

            p = new Pen(Color.Red, 3);

            for (i = 0; i < 4; i++)
            {
                g.DrawLine(p, 0 + show_waist_size * i + show_max_height_size * i + show_waist_size / 2, show_head_size,
                        0 + show_waist_size * i + show_max_height_size * i + show_waist_size / 2, show_head_size + show_max_width_size);
            }
            for (i = 0; i < 2; i++)
            {
                g.DrawLine(p, show_waist_size / 2, show_head_size + show_max_width_size * i,
                        show_waist_size / 2 + pictureBox1.Width, show_head_size + show_max_width_size * i);
            }
            ...
            //g.DrawRectangle(p, 0, 0, pictureBox1.Width - 1, pictureBox1.Height - 1);
            //g.DrawLine(p, 0 + show_waist_size, show_head_size, 0 + show_waist_size, show_head_size + show_max_width_size);

            //g.DrawLine(p, 0 + show_waist_size * 1 + show_max_height_size * 1, show_head_size, 0 + show_waist_size * 1 + show_max_height_size * 1, show_head_size + show_max_width_size);
            //g.DrawLine(p, 0 + show_waist_size * 2 + show_max_height_size * 2, show_head_size, 0 + show_waist_size * 2 + show_max_height_size * 2, show_head_size + show_max_width_size);
            //g.DrawLine(p, 0 + show_waist_size * 3 + show_max_height_size * 3, show_head_size, 0 + show_waist_size * 3 + show_max_height_size * 3, show_head_size + show_max_width_size);
