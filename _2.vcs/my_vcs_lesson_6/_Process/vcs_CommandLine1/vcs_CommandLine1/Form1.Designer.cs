namespace vcs_CommandLine1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button3.Text = "調用外部程序，並獲取輸出和錯誤信息";
            ...
            this.button2.Text = "執行外部.EXE檔 並獲取結果";
            ...
            this.button1.Text = "調用外部程序以及執行dos命令";
            ...
            this.button8.Text = "取得系統開啟的端口和狀態";
