...
namespace vcs_Comport_Sample_PuTTY
{
    public partial class Form1 : Form
    {
        ...
        void show_item_location()
        {
            ...
            groupBox_comport.Location = new Point(x_st + dx * 0, y_st + dy * 0);

            richTextBox1.Size = new Size(800, 500);
            richTextBox1.Location = new Point(x_st + dx * 0, y_st + dy * 1 + 10);
            bt_clear.Location = new Point(richTextBox1.Location.X + richTextBox1.Size.Width - bt_clear.Size.Width, richTextBox1.Location.Y + richTextBox1.Size.Height - bt_clear.Size.Height);

            this.Size = new Size(840, 640);
            this.Text = "vcs_Comport_Sample_PuTTY";
