...
namespace vcs_SpeechSynthesizer1
{
    public partial class Form1 : Form
    {
        ...
        private void show_item_location()
        {
            ...
            richTextBox1.Size = new Size(750, 690);
        ...
        {
            string text = "這是 Copilot 的回覆，現在用電腦喇叭播放出來。";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.Text += "播放速度 : " + synth.Rate.ToString() + "\n";
            richTextBox1.Text += "音量大小 : " + synth.Volume.ToString() + "\n";

            string filename = "1tmp_wav_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".wav";
            ...
            filename = "2tmp_wav_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".wav";
