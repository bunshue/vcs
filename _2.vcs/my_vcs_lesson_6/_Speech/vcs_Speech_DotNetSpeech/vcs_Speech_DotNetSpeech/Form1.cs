...
namespace vcs_Speech_DotNetSpeech
{
    public partial class Form1 : Form
    {
        ...
        /// <returns></returns>
        public bool WriteToWAV(string path, string str, SpeechAudioFormatType SpAudioType)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            setRate(0);
            setVolume(100);
            WriteToWAV("aaa.wav", text, SpeechAudioFormatType.SAFTCCITT_uLaw_11kHzMono); //SAFT11kHz16BitMono 生成wav文件
        }
