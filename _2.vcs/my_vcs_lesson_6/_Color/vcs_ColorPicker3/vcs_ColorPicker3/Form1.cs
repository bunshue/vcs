...
namespace vcs_ColorPicker3
{
    public partial class Form1 : Form
    {
        ...
        {
            label1.Text = "鼠標位置 : " + Control.MousePosition.X.ToString() + "," + Control.MousePosition.Y.ToString();
            Point pt = new Point(Control.MousePosition.X, Control.MousePosition.Y);
            Color cl = GetColor(pt);
            pictureBox1.BackColor = cl;
            label2.Text = "RGB值 : " + cl.R + "," + cl.G + "," + cl.B;
            label3.Text = "網頁顏色 : " + ColorTranslator.ToHtml(cl).ToString();
