...
namespace vcs_Cryptography4
{
    public partial class Form1 : Form
    {
        ...
        string filename1 = @"C:\______test_files1\__RW\_txt\txt_clear.txt";          //明碼
        string filename2 = @"C:\______test_files1\__RW\_txt\txt_encrypt.txt";        //密碼
        ...
        {
            //檔案加密2
            string inFile = @"C:\______test_files1\picture1.jpg";
        ...
        {
            //檔案解密2
            string inFile = @"C:\______test_files1\picture1.jpg.dat";
