...
namespace myson_link
{
    public partial class Form1 : Form
    {
        ...
        public void Update_Language(int idx)
        {
            ...
            button_update_status.Text = language1[idx, 3];
        ...
        void Write_Log_File(string input)
        {
            ...
            {
                //int i;
                if (System.IO.File.Exists(mysonlink_log_filename) == false)
                {
                    //MessageBox.Show("檔案 " + mysonlink_log_filename + " 不存在，製作一個。");
                    StreamWriter sw = File.CreateText(mysonlink_log_filename);
                    sw.Write(log_file_tmp_data);
                    sw.Close();
                }
                else
                {
                    //MessageBox.Show("檔案 " + mysonlink_log_filename + " 存在, 開啟，並接續寫入資料");

                    StreamWriter sw = File.AppendText(mysonlink_log_filename);
                    sw.Write(log_file_tmp_data);
                    sw.Close();
                }
        ...
        {
            int i;
            if (System.IO.File.Exists(mysonlink_setup_filename) == false)
            {
                //MessageBox.Show("檔案 " + mysonlink_setup_filename + " 不存在，製作一個。");
                StreamWriter sw = File.CreateText(mysonlink_setup_filename);
                string content = "";
            ...
            {
                //MessageBox.Show("檔案 " + mysonlink_setup_filename + " 存在, 開啟，並讀入設定");

                String line;
                StreamReader sr = new StreamReader(mysonlink_setup_filename);
                for (i = 0; i < 2; i++)
                {
                    line = sr.ReadLine();
        ...
        private void Reset_MysonLink_Setting()
        {
            ...
            button_update_status.Text = language1[comboBox3.SelectedIndex, 3];
            ...
            button33.BackgroundImage = myson_link.Properties.Resources.open_log;
            ...
            pictureBox3.Image = myson_link.Properties.Resources.CW;
            pictureBox4.Image = myson_link.Properties.Resources.CW;
            pictureBox5.Image = myson_link.Properties.Resources.CW;
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.AppendText("[PC]: Reset MysonLink\n");
            richTextBox1.ScrollToCaret();       //RichTextBox顯示訊息自動捲動，顯示最後一行
            Reset_MysonLink_Setting();
            refresh_meter();
        }
                ...
                else if (input[0] == 0xC1)          //0xC1: 收到下位發送的馬達參數命令
                {
                    ...
                    else if (input[1] == _CONTROL)
                    {
                        ...
                        else
                        {
                            ...
                            control_1 = 1;
                            IsCCW = 1;
                            pictureBox3.Image = myson_link.Properties.Resources.CCW;
                            pictureBox4.Image = myson_link.Properties.Resources.CCW;
                            pictureBox5.Image = myson_link.Properties.Resources.CCW;
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (System.IO.File.Exists(ezisp_path) == false)
            {
                ...
                if (oFD.ShowDialog() == DialogResult.OK)
                {
                    ...
                    FileStream filestream = File.Open(mysonlink_setup_filename, FileMode.Create);
                    ...
                    // Close FileStream
                    filestream.Close();
                    //MessageBox.Show("儲存資料完畢111，檔案：" + mysonlink_setup_filename);
                }
                else
                {
        ...
        private void button_Run_Click(object sender, EventArgs e)
        {
            if (!serialPort1.IsOpen)
            {
                MessageBox.Show("No Comport", "MysonLink", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            //button_Run.Enabled = false;
            //button_Stop.Enabled = true;
        ...
        {
            if (Update_System_Status == 1)
            {
                Send_Update_System_Status_Cmd(0);
                //button_update_status.Text = "更新狀態";
                button_update_status.Text = language1[comboBox3.SelectedIndex, 2];
                button_update_status.ForeColor = Color.Green;
                Update_System_Status = 0;
                label_target_speed2.Text = "---";
                label_speed2.Text = "-";
                label_target_speed.Text = "---";
                label_rpm.Text = "---";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.AppendText("MysonLink登錄時間 : " + "2017/1/3 03:00下午" + "\n");
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            // Close FileStream
            filestream.Close();
            //MessageBox.Show("儲存資料完畢222，檔案：" + mysonlink_setup_filename);
        }
        ...
        private void button28_Click(object sender, EventArgs e)
        {
            ...
            if (oFD.ShowDialog() == DialogResult.OK)
            {
                ...
                string context = string.Empty;
                FileStream filestream = File.Open(mysonlink_setup_filename, FileMode.Open);
                StreamWriter str_writer = new StreamWriter(filestream);
                ...
                // Close FileStream
                filestream.Close();
                //MessageBox.Show("儲存資料完畢111，檔案：" + mysonlink_setup_filename + "路径：" + ezisp_path);
        ...
        private void button_phase_comp_st_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Phase angle setup error!", "MysonLink", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void button71_Click(object sender, EventArgs e)
        {
            ...
            if (IsPhaseComp == 0)
            {
                MessageBox.Show("尚未開啟相位補償功能", "MysonLink", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            if (tb_phase_comp.Text.Length > 0)
            {
        ...
        private void button33_Click(object sender, EventArgs e)
        {
            ...
            {
                show_comport_log = 1;
                button33.BackgroundImage = myson_link.Properties.Resources.close_log;
                this.Width += 400;
            }
            else
            {
        ...
        {
            //建立一個檔案
            string filename = "MysonLink_Log." + DateTime.Now.ToString("MMdd.HH.mm") + ".txt";
        ...
        {
            richTextBox1.AppendText("[PC]: MysonLink mode\n");
            Comport_Mode = 0;
            this.richTextBox1.Location = new System.Drawing.Point(958, 67);
            this.richTextBox1.Size = new System.Drawing.Size(382, 594);
        }
