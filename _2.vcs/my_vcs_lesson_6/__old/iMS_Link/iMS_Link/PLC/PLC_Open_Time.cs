...
namespace iMS_Link.SetupControls
{
    //==============================================================
    //  作者：BAtoDA
    //  文件名：PLC_Open_Time 
    ...
    public class PLC_Open_Time : Timer
    {
        ...
        public string MitsubishiIP
        {
            ...
            set
            {
                Mitsubishi_ip = IPAddress.Parse("192.168.3.40");
            }
        }

        private IPAddress Mitsubishi_ip = IPAddress.Parse("192.168.3.40");
        public int MitsubishiPort = 1234;
