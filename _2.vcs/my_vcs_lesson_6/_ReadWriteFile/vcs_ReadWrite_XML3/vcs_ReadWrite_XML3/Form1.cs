...
namespace vcs_ReadWrite_XML3
{
    public partial class Form1 : Form
    {
        ...
        {
            string filename = "C:\\______test_files\\__RW\\_xml\\宅之力R.xml";
        ...
        {
            string filename = "C:\\______test_files\\__RW\\_xml\\宅之力W.xml";
        ...
        {
            string filename = "C:\\______test_files\\__RW\\_xml\\仙人的設計之路2.xml";
            if (File.Exists(filename))
            {
                XmlDocument document = new XmlDocument();
                richTextBox1.Text += "開啟XML文件 : " + filename + "\n";
