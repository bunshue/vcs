...
namespace vcs_ReadWrite_XML1A
{
    public partial class Form1 : Form
    {
        ...
        //XML操作0
        string filename0 = @"C:\______test_files1\__RW\_xml\vcs_ReadWrite_XML1.xml";
        string filename0_add = @"C:\______test_files1\__RW\_xml\vcs_ReadWrite_XML1_add.xml";
        string filename0_delete = @"C:\______test_files1\__RW\_xml\vcs_ReadWrite_XML1_delete.xml";
        ...
        {
            string filename1a = @"C:\______test_files1\__RW\_xml\宅之力R.xml";
        ...
        {
            string filename1b = @"C:\______test_files1\__RW\_xml\宅之力W.xml";
        ...
        {
            string filename1c = @"C:\______test_files1\__RW\_xml\仙人的設計之路2.xml";
        ...
        string xml_filename2 = @"C:\______test_files1\__RW\_xml\vcs_ReadWrite_XML2.xml";
        ...
        private void button40_Click(object sender, EventArgs e)
        {
            //使用LINQ讀取XML
            //使用LINQ讀取XML
            string sURL = @"C:\______test_files1\__RW\_xml\weather_current.xml";
