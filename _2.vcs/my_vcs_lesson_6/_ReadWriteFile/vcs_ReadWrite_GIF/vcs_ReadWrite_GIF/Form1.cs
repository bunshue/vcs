...
namespace vcs_ReadWrite_GIF
{
    ...
    {
        string filename1 = @"C:\______test_files\__pic\_gif\dog.gif";
        string filename2 = @"C:\______test_files\__pic\_gif\cat.gif";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string filename = @"C:\______test_files\__pic\_gif\sky.gif";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string dirname = @"C:\______test_files\__pic\_gif\png2gif";
