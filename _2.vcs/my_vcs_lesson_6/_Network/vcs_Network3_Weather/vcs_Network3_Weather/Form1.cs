...
namespace vcs_Network3_Weather
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string filename = "C:\\______test_files1\\__RW\\_txt\\api_key.txt";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string filename = "C:\\______test_files1\\__RW\\_xml\\weather_forecast.xml";
            ParseXML(filename);
            show_data();
        }
        // 標準版XML讀取解析程式 SP
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            string filename = "C:\\______test_files1\\__RW\\_xml\\weather_current.xml";
