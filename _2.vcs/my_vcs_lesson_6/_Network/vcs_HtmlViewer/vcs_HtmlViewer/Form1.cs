...
namespace vcs_HtmlViewer
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            webBrowser1.ScriptErrorsSuppressed = true;  //關閉 指令碼偵錯視窗, 不然會有一大堆訊息窗
        ...
        void show_item_location()
        {
            ...
            richTextBox_html.Size = new Size(620, 300);
            richTextBox_html.Location = new Point(x_st + dx * 1, y_st + dy * 0);
            webBrowser1.Size = new Size(620, 300);
            webBrowser1.Location = new Point(x_st + dx * 1, y_st + dy * 5);
            richTextBox1.Size = new Size(300, 690);
            richTextBox1.Location = new Point(x_st + dx * 4, y_st + dy * 0);
            bt_clear.Location = new Point(richTextBox1.Location.X + richTextBox1.Size.Width - bt_clear.Size.Width, richTextBox1.Location.Y + richTextBox1.Size.Height - bt_clear.Size.Height);

            this.Size = new Size(1173, 750);
            this.Text = "vcs_HtmlViewer";
