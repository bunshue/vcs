...
namespace vcs_AudioVideoTest1
{
    public partial class Form1 : Form
    {
        ...
        private void button0_Click(object sender, EventArgs e)
        {
            ...
            //SoundPlayer sp = new SoundPlayer(@"C:\______test_files1\_wav\WindowsShutdown.wav");
        ...
        {
            PlayWav(@"C:\______test_files1\_wav\Frog.wav", false);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            PlayWav(@"C:\______test_files1\_wav\Frog.wav", true);
        }
        ...
        {
            wplayer.URL = @"C:\______test_files1\_mp3\aaaa.mp3";
        ...
        {
            /// 利用C#來解讀MP3文件的TAG區信息。
            //string mp3_filename = @"C:\______test_files1\_mp3\aaaa.mp3";
        ...
        {
            //從mp3檔名找lrc
            string filename = @"C:\______test_files1\_mp3\04-三月雪(&黃妃).mp3";
