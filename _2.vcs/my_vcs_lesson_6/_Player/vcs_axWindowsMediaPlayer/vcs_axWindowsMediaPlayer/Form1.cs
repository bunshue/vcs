...
namespace vcs_axWindowsMediaPlayer
{
    ...
    {
        string filename = @"D:\_git\vcs\_1.data\______test_files1\enka.avi";
        //string filename = @"D:\_git\vcs\_1.data\______test_files1\_mp3\07    都はろみ--妻戀道中(他鄉思妻兒).mp3";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //axWindowsMediaPlayer1.URL = @"D:\_git\vcs\_1.data\______test_files1\_mp3\16.監獄風雲.mp3";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ofd.InitialDirectory = @"D:\_git\vcs\_1.data\______test_files1\_mp3";
