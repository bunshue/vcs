...
namespace vcs_MP3Player_winmm
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        {
            //richTextBox1.Text += (GetMediaLen(@"C:\_git\vcs\_1.data\______test_files1\_wav\WindowsShutdown.wav").ToString() + " 秒\n");
            //richTextBox1.Text += (GetMediaLen(@"C:\_git\vcs\_1.data\______test_files1\_mp3\aaaa.mp3").ToString() + " 秒");
