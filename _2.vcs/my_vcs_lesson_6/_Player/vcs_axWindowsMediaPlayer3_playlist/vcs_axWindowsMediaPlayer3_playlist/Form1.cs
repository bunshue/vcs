...
namespace vcs_axWindowsMediaPlayer3_playlist
{
    ...
    {
        string filename_r = @"D:\_git\vcs\_1.data\______test_files1\_mp3\list.m3u";
        ...
        {
            openFileDialog1.InitialDirectory = @"D:\_git\vcs\_1.data\______test_files1\_mp3";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            full_filename = @"D:\_git\vcs\_1.data\______test_files1\_mp3\16.監獄風雲.mp3";
            ...
            */
            ...
            full_filename = @"D:\_git\vcs\_2.vcs\______test_files1\_wav\start.wav";
            short_filename = Path.GetFileNameWithoutExtension(full_filename);//保存打開的文件的文件名
            m3uWrite(full_filename, m3u_filename);//向M3U文件中寫入內容
