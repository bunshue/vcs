...
namespace vcs_axWindowsMediaPlayer3_playlist
{
    ...
    {
        string filename_r = @"C:\_git\vcs\_1.data\______test_files1\_mp3\list.m3u";
        ...
        {
            openFileDialog1.InitialDirectory = @"C:\_git\vcs\_1.data\______test_files1\_mp3";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            full_filename = @"C:\_git\vcs\_1.data\______test_files1\_mp3\16.監獄風雲.mp3";
