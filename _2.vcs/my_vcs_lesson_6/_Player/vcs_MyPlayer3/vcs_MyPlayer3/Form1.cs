        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (axWindowsMediaPlayer1.playState == WMPLib.WMPPlayState.wmppsPlaying)
            {
                ...
                */
                ...
                e.Graphics.DrawString(title, new Font("標楷體", 10), new SolidBrush(Color.Green), new PointF(10, 10));
                ...
                e.Graphics.DrawString(play_info, f, new SolidBrush(Color.Green), new PointF(W - tmp_width, 10));
