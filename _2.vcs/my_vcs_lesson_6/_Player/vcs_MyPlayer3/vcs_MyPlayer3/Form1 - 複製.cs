...
namespace vcs_MyPlayer3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (flag_display_mode == MODE_1)
            {
                ...
                string filename = @"D:\vcs\_語言雜誌壓縮檔\_空中英語教室\202103彭蒙惠英語\202103彭蒙惠英語.pdf";
            ...
            else if (e.KeyData == Keys.P)
            {
                ...
                if (openFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    */
                    ...
                    lb_main_mesg1.Location = new Point(this.ClientSize.Width / 2, this.pictureBox1.Location.Y + 2);
                    lb_main_mesg1.Text = "";
                    lb_main_mesg1.BringToFront();
        ...
        private void pictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            int H = pictureBox1.Height;
            if (e.Y < (this.ClientSize.Height - H * 3 / 5))
            {
