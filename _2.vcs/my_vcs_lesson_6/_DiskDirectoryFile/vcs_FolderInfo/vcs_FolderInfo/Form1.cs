...
namespace vcs_FolderInfo
{
    public partial class Form1 : Form
    {
        ...
        private void show_item_location()
        {
            ...
            listView1.Size = new Size(750, 340-60);
            listView1.Location = new Point(x_st + dx * 1, y_st + dy * 0+60);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.Text += "總容量   : " + ByteConversionTBGBMBKB(Convert.ToInt64(total_size2)) + "\n";
