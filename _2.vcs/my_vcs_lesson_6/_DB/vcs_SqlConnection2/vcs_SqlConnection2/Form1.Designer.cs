namespace vcs_SqlConnection2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button3.Text = "使用IN引入子查詢限制查詢範圍";
            ...
            this.button15.Text = "查詢庫存數量占後20%的圖書訊息";
            ...
            this.button17.Text = "使用COMPUTE BY";
