...
namespace vcs_SqlConnection1
{
    public partial class Form1 : Form
    {
        ...
        private void button0_Click(object sender, EventArgs e)
        {
            ...
            sql_read_database(db_filename, sqlstr, dataGridView1);
            lb_dgv1.Text = "工資表, 由 所屬部門 排序";

            richTextBox1.Text += "------------------------------\n";  // 30個

            // 查詢字串, 欄名使用別名AS, GROUP BY 同項合併
            sqlstr = "SELECT 所屬部門, 性別, AVG(工資) AS 平均工資 FROM 工資表 GROUP BY 所屬部門, 性別";
            sql_read_database(db_filename, sqlstr, dataGridView2);
            lb_dgv2.Text = "工資表, 同項合併";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            //sqlstr = "SELECT COUNT(*), MAX(體重), AVG(體重) FROM animals1_table";
        ...
        private void button28_Click(object sender, EventArgs e)
        {
            ...
            // 用 LIKE 看看 左右模糊
            sqlstr = "DELETE FROM 員工表 WHERE 員工編號 LIKE '%" + "P1007" + "%'";
