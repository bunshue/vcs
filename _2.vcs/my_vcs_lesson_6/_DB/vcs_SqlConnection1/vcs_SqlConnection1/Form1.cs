    ...
    public partial class Form1 : Form
    {
        ...
        private void button0_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //工資統計
            //利用having語句過濾分組數據
            // 查詢字串, HAVING 語句運用在多表查詢中, 過濾分組數據, 欄名使用別名AS
            ...
            richTextBox1.Text += "查詢 計算機 課程的平均成績 : " + obj.ToString() + "\n";
            ...
            db_filename = "db_10_Data.MDF";
            // 查詢字串
            sqlstr = "SELECT * FROM 明細工資表 WHERE (基本工資 IN (SELECT 基本工資 FROM 明細工資表 WHERE 基本工資 > " + money_low.ToString() + " AND 基本工資 < " + money_high.ToString() + "))";
            sql_read_database(db_filename, sqlstr, dataGridView2);
            lb_dgv2.Text = "查詢 1000~1500 明細工資表";
...
sqlstr = "SELECT 產品編號,產品名稱 FROM tb_WidgetApply";//定義一個數據庫查詢字符串
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            /*
            // 查詢字串, WHERE + 模糊比對, 左右模糊, 左右都任意
            sqlstr = sqlstr + " WHERE " + FieldName + " LIKE '%" + FieldValue + "%'";
            // 查詢字串, WHERE + 模糊比對, 左模糊, 右需相符, 左邊任意
            sqlstr = sqlstr + " WHERE " + FieldName + " LIKE '%" + FieldValue + "'";
            // 查詢字串, WHERE + 模糊比對, 右模糊, 左需相符, 右邊任意
            sqlstr = sqlstr + " WHERE " + FieldName + " LIKE '" + FieldValue + "%'";
            */
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            // 查詢字串, 欄名使用別名AS
            sqlstr = "SELECT * FROM animals1_table";
            sqlstr = "SELECT COUNT(*) AS 個數, SUM(體重) AS 總重, ROUND(AVG(體重), 2) AS 平均, MAX(體重) AS 最大, MIN(體重) AS 最小 FROM animals1_table";
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            ...
            // 查詢字串, 查詢體重佔後30%的動物訊息
            sqlstr = "SELECT TOP 30 percent * FROM animals1_table ORDER BY 體重 ASC";
            sql_read_database(db_filename, sqlstr, dataGridView2);
