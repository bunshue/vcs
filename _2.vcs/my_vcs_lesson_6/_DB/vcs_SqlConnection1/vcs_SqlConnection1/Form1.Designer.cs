namespace vcs_SqlConnection1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button26.Text = "查詢字串 WHERE 的用法";
