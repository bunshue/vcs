        ...
        void drawSpectrum(Bitmap bitmap1)
        {
            ...
            for (j = 0; j < awb_window_size; j++)
            {
                for (i = 0; i < awb_window_size; i++)
                {
                    ...
                    //richTextBox1.Text += wave_index.ToString() + " " + rgb_data[wave_index, 0].ToString() + " ";
            ...
            float ratio_x = (float)W / 81;

            float ratio_y = (float)H / max;

            richTextBox1.Text += " RX = " + ratio_x.ToString() + " ";
            richTextBox1.Text += " RY = " + ratio_y.ToString() + " ";
            richTextBox1.Text += " M = " + max.ToString() + " ";
            ...
            for (i = 0; i < 81; i++)
            {
                ...
                curvePoints[i].X = (int)(ratio_x * i);
                //curvePoints[i].Y = H - (int)(data_array[i] * 1);
                curvePoints[i].Y = (int)(H - data_array[i] * ratio_y - margin);
                //curvePoints[i].Y = 2 * i;
            }
