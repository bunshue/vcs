    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (webcam_count > 0)
            {
                ...
                //this.CamMonitor = new CameraMonitor(pictureBox1, camera_name, USBWebcams[0].Name);
                this.CamMonitor = new CameraMonitor(pictureBox1, camera_name, "第 1 台攝影機");
                /*
                richTextBox1.Text += "短名 : " + USBWebcams[0].Name + "\n";
                richTextBox1.Text += "長名 : " + USBWebcams[0].MonikerString + "\n";
                */
            }
        }
        ...
        {
            if (this.CamMonitor.IsRecording == true)
            {
                this.CamMonitor.StopRecording();
        ...
        private void DrawMessage(object sender, PaintEventArgs e)
        {
            using (Font f = new Font("Arial", 14, FontStyle.Bold))
            {
                ...
                if (this.IsRecording == true)
                {
                    ...
                    {
                        e.Graphics.DrawString("錄影中", f, Brushes.Red, new Point(2, 36));
