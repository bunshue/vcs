...
namespace vcs_WebCam_AForge4
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (this.CamMonitor.IsRecording)
            {
            }
            else
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                this.CamMonitor.IsRecording = false;
    ...
    class CameraMonitor
    {
        ...
        private void DoRecord()
        {
            ...
            //vw.Open("C:\\dddddddddd\\" + this.cameraName + String.Format("{0:_yyyy-MM-dd_hh-mm-ss}", DateTime.Now) + ".avi", this.Width, this.Height, 15);
            vw.Open("C:\\dddddddddd\\" + this.cameraName + String.Format("{0:_yyyy-MM-dd_hh-mm-ss}", DateTime.Now) + ".avi", 1920, 1080, 25);
        ...
        public void StartRecording()
        {
            if (IsRecording == false)
            {
                ...
                string filename = @"C:\EEEEdddddddddd\" + this.cameraName + String.Format("{0:_yyyy-MM-dd_hh-mm-ss}", DateTime.Now) + ".avi";

                Console.WriteLine("filename : " + filename);
                //vw.Open(filename, 1920, 1080, 25);
