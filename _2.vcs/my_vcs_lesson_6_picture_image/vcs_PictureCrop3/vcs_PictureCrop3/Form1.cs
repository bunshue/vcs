...
namespace vcs_PictureCrop3
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            Bitmap bm_white = GetSelectedArea(pictureBox1.Image, Color.White, Points);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                Rectangle source_rect = new Rectangle(0, 0, bitmap2.Width, bitmap2.Height);
                Rectangle dest_rect = new Rectangle(x, y, bitmap2.Width, bitmap2.Height);
                gr.DrawImage(bitmap2, dest_rect, source_rect, GraphicsUnit.Pixel);
            }
