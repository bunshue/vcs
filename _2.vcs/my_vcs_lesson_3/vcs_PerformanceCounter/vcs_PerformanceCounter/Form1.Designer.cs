namespace vcs_PerformanceCounter
{
    partial class Form1
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // progressBar1
            // 
            this.progressBar1.Location = new System.Drawing.Point(28, 109);
            ...
            this.richTextBox1.Text = "使用PerformanceCounter監控並顯示CPU狀態訊息\n\nPerformance Counter控件屬性\n\nCategoryName 填 Process" +
                "or\nCounterName 填 % Processor Time\nInstanceName 填 _Total\n//如果要監控單個處理器的狀態，屬性Instan" +
                "ceName需設為指向某個特定的處理器(比如說0或1)\n";
            // 
            // timer1
            // 
