    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listView1.Items.Count; i++)
            {
                ...
                //richTextBox1.Text += "i=" + i.ToString() + " ：" + t.Text + " " + t.SubItems[1].Text + "\t" + t.SubItems[2].Text + "\n";
                richTextBox1.Text += listView1.Items[i].Text + "\t" + listView1.Items[i].SubItems[1].Text + "\t" + listView1.Items[i].SubItems[2].Text + "\n";
            }
        }
