...
namespace vcs_ComboBox2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cboTimeZones.SelectedItem = FindItemContaining(cboTimeZones.Items, "Mountain Time");
            lstTimeZones.SelectedItem = FindItemContaining(lstTimeZones.Items, "Mountain Time");
        }
