...
namespace ChildRefurbishParent
{
    public partial class ChildRefurbishParent : Form
    {
        ...
        // 連接字串
        string cnstr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\db_01_Data.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        private void ChildRefurbishParent_Load(object sender, EventArgs e)
        {
            ...
            ConnPubs = new SqlConnection(cnstr);//建立数据库连接
