...
using System.IO;//for Directory, 聲明與文件的輸入輸出流有關的命名空間
...
namespace vcs_ListView3_ContextMenuStrip
{
    public partial class Form1 : Form
    {
        ...
        void show_item_location()
        {
            ...
            lb_main_mesg0.Location = new Point(x_st + dx * 0, y_st + dy * 0);
            button0.Location = new Point(x_st + dx * 0, y_st + dy * 0 + 100);
            ...
            lb_main_mesg0.Text = "listView1 屬性 的 ContextMenuStrip\n加 contextMenuStrip1";
        }
