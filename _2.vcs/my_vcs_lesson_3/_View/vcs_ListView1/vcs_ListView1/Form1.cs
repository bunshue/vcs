...
namespace vcs_ListView1
{
    public partial class Form1 : Form
    {
        ...
        void show_item_location()
        {
            ...
            lb_main_mesg0.Location = new Point(x_st + dx * 3, y_st + dy * 9 + 20);
            lb_main_mesg0.Text = "";
            lb_main_mesg1.Location = new Point(x_st + dx * 5, y_st + dy * 9 + 14);
            lb_main_mesg1.Text = "listView1 屬性 的 ContextMenuStrip\n加 contextMenuStrip1";

            listView1.Size = new Size(830, 690 - 50);
        ...
        private void apply_listView08()
        {
            ...
            //設定欄位, 欄名, 欄寬, 對齊方式
            listView1.Columns.Add("文件名稱", 120, HorizontalAlignment.Left);
            listView1.Columns.Add("文件屬性", 210, HorizontalAlignment.Left);
            listView1.Columns.Add("創建時間", 200, HorizontalAlignment.Left);
        ...
        void apply_listView09()
        {
            ...
            //設定欄位, 欄名, 欄寬, 對齊方式
            listView1.Columns.Add("文件名稱", 150, HorizontalAlignment.Left);
            listView1.Columns.Add("創建時間", 200, HorizontalAlignment.Left);
        ...
        {
            //建立listView 11
            richTextBox1.Text += "建立listView 11 成績單\n";
            listView1.Clear();
            apply_listView11();
            test_listView11();
        }
        ...
        {
            string str = listView1.SelectedItems[0].Text.ToString(); // 取出第0欄的資料
