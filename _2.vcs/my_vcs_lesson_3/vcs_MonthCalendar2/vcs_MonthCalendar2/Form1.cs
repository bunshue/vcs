...
namespace vcs_MonthCalendar2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // 設定BoldedDates
            monthCalendar1.BoldedDates = new System.DateTime[] { new System.DateTime(2013, 9, 26, 0, 0, 0, 0) };
        ...
        {
            label1.Text = "改變後的日期： 開始是： " + e.Start.ToShortDateString() + " ，結束是： " + e.End.ToShortDateString();
        }

        private void monthCalendar1_DateSelected(object sender, DateRangeEventArgs e)
        {
            textBox1.Text = "選取後的日期： 開始是： " + e.Start.ToShortDateString() + "，結束是： " + e.End.ToShortDateString();
        }
    }
}
