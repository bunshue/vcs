...
namespace howto_weather_forecast2
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        {
            richTextBox1.Text += "琩高篈 : " + comboBox1.Text + "\t絏 : " + QueryCodes[comboBox1.SelectedIndex] + "\n";
        ...
        private void DisplayForecast(string xml)
        {
            ...
            richTextBox1.Text += "カ\t" + loc_node.SelectSingleNode("name").InnerText + "\n";
            txtCountry.Text = loc_node.SelectSingleNode("country").InnerText;
            richTextBox1.Text += "瓣產\t" + loc_node.SelectSingleNode("country").InnerText + "\n";
            XmlNode geo_node = loc_node.SelectSingleNode("location");
            txtLat.Text = geo_node.Attributes["latitude"].Value;
            richTextBox1.Text += "絥\t" + geo_node.Attributes["latitude"].Value + "\n";
            txtLong.Text = geo_node.Attributes["longitude"].Value;
            richTextBox1.Text += "竒\t" + geo_node.Attributes["longitude"].Value + "\n";
