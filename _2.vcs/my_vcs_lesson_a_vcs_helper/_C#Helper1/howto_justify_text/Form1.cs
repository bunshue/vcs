...
namespace howto_justify_text
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox_justify2_Paint(object sender, PaintEventArgs e)
        {
            e.Graphics.Clear(pictureBox_justify2.BackColor);
            e.Graphics.TextRenderingHint = TextRenderingHint.AntiAliasGridFit;

            // Draw within a rectangle excluding the margins.
            RectangleF rect = new RectangleF(
                TextMargin.Left, TextMargin.Top,
                pictureBox_justify2.ClientSize.Width - TextMargin.Left - TextMargin.Right,
                pictureBox_justify2.ClientSize.Height - TextMargin.Top - TextMargin.Bottom);
        ...
        private void pictureBox_justify2_Resize(object sender, EventArgs e)
        {
