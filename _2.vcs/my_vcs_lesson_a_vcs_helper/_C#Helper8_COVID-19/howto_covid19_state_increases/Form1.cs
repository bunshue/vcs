...
namespace howto_covid19_state_increases
{
    public partial class Form1 : Form
    {
        ...
        private List<StateData> SelectedStates = new List<StateData>();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            richTextBox1.Text += "statelist count = " + StateList.Count.ToString() + "\n";
        ...
        private void LoadData()
        {
            ...
            {
                //richTextBox1.Text += "第 " + j.ToString() + " 欄 : " + fields[0, j].ToString() + "\n";
                /*
                if (fields[1, i].ToString().ToLower() == header.ToLower())
                    return i;
                */
            ...
            richTextBox1.Text += "call CreateStateData\n";
        ...
        private StateData GetOrCreateStateData(string state_name)
        {
            ...
            state_data.PositiveIncrease = new float[NumDates];
            state_data.HospitalizedIncrease = new float[NumDates];
            state_data.DeathsIncrease = new float[NumDates];
        ...
        private void CreateStateData(object[,] fields)
        {
            ...
            for (int row = 2; row < max_row; row++)
            {
                ...
                state_data.PositiveIncrease[date_num] = ParseValue(fields[row, colPositiveIncrease]);
                state_data.HospitalizedIncrease[date_num] = ParseValue(fields[row, colHospitalizedIncrease]);
                state_data.DeathsIncrease[date_num] = ParseValue(fields[row, colDeathsIncrease]);
                ...
                all_data.PositiveIncrease[date_num] += state_data.PositiveIncrease[date_num];
                all_data.HospitalizedIncrease[date_num] += state_data.HospitalizedIncrease[date_num];
                all_data.DeathsIncrease[date_num] += state_data.DeathsIncrease[date_num];
            }

            // Calculate deaths per resolution.
            for (int date_num = 0;
        ...
        private void clbCountries_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            StateData checked_state = clbStates.Items[e.Index] as StateData;
            ...
            StateData checked_state, CheckState checked_status)
        {
            ...
            richTextBox1.Text += "current checked items count = " + clbStates.CheckedItems.Count.ToString() + "\n";
            ...
            else
            {
                ...
                state_list = clbStates.CheckedItems.Cast<StateData>().ToList();
            }
        ...
        private void SortStates()
        {
            ...
            clbStates.DataSource = StateList;   //show data on the checked-list-box
        ...
        {
            richTextBox1.Text += "show all state data\n";
            for (int i = 0; i < clbStates.Items.Count; i++)
            {
                richTextBox1.Text += "i = " + i.ToString() + "\t" + clbStates.Items[i] + "\n";
                //clbStates.SetItemChecked(i, true);
            }
