...
namespace howto_covid19_state_increases
{
    public partial class Form1
    {
                                                        private void LoadPopulationData()
                                                        {
                                                            ...
                                                            richTextBox1.Text += "No population data for these states:\n";
                                                            foreach (StateData state in StateList)
                                                            {
                                                                ...
                                                                if (population_dict.ContainsKey(state.Name))
                                                                {
                                                                    ...
                                                                    //richTextBox1.Text += "Name = " + state.Name + "\tPopulation = " + population_dict[state.Name].ToString() + "\n";
                                                                }
                                                                else
                                                                {
                                                                    Console.WriteLine(state.Name);
                                                                    //richTextBox1.Text += "Name = " + state.Name + "\n";
                                                                }
