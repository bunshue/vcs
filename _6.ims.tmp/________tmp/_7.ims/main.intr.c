...
#define IIC_SLAVE_ADDR		0xD0	//RTC
...
int main()
{
	...
	*/
	...
	Status = IicPsMasterIntrExample(0);
...
int IicPsMasterIntrExample(u16 DeviceId)
{
	...
	xil_printf("david0716: %s:%s(%d) ST I2C%d addr=0x%x\r\n",__FILE__,__func__,__LINE__,DeviceId,Config->BaseAddress);
	 ...
	 */
	//XIicPs_MasterSend(&Iic, SendBuffer, BufferSizes[Index], IIC_SLAVE_ADDR);

	send_data = 0x07;
	receive_data = 0;
	XIicPs_MasterSend(&Iic, &send_data, 1, IIC_SLAVE_ADDR);
	...
	while(0)
	{
		...
		XIicPs_MasterSend(&Iic, &send_data, 1, IIC_SLAVE_ADDR);
		XIicPs_MasterRecv(&Iic, &receive_data, 1,	IIC_SLAVE_ADDR);
		xil_printf("get data : 0x%x", receive_data);


		usleep(200000);usleep(200000);usleep(200000);usleep(200000);usleep(200000);
		usleep(200000);usleep(200000);usleep(200000);usleep(200000);usleep(200000);
		usleep(200000);usleep(200000);usleep(200000);usleep(200000);usleep(200000);
		usleep(200000);usleep(200000);usleep(200000);usleep(200000);usleep(200000);
		usleep(200000);usleep(200000);usleep(200000);usleep(200000);usleep(200000);
