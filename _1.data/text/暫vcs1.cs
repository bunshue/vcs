...
正式名稱為國際傑出數學發現獎（英語：International Medals for Outstanding Discoveries in Mathematics），
是一個在國際數學聯盟的國際數學家大會上頒發的獎項。
每四年評選2-4名有卓越貢獻且年齡不超過40歲的青年數學家。
得獎者須在該年元旦前未滿四十歲。
...
年分 		4 	西元年分，四個數字。
評論 		28或30 	就是評論。
零位元組 	1 	如果有儲存曲目，那麼這個位元組會儲存一個二進位的0。
曲目 		1 	這首歌在該專輯中的曲目，或者為0。若前一個位元組非零，則此欄內容無效。
藝術類型 
