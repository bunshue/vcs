...
pictureboxÅã¥Ü¹ÏÀÉ
            ...
            string filename = @"C:\______test_vcs\07    ³£???--©dÅÊ¹D¤¤(¥L¶m«ä©d¨à).mp3";
            FileInfo f = new FileInfo(filename);

            //C# ¨ú±oÀÉ®×«Ø¥ß¤é´Á,¤Î³Ì«á­×§ï¤é´Á 
            richTextBox1.Text += "ÀÉ®×«Ø¥ß¤é´Á" + f.CreationTime.ToString() + "\n";
            richTextBox1.Text += "ÀÉ®×³Ì«á­×§ï¤é´Á" + f.LastWriteTime.ToString() + "\n";
